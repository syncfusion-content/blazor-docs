...
This section briefly explains about how to include a [Blazor DatePicker](https://www.syncfusion.com/blazor-components/blazor-datepicker) Component in your Blazor Server-Side and Client-Side application. You can refer to our Getting Started with [Blazor Server-Side DatePicker](../getting-started/blazor-server-side-visual-studio/) and [Blazor WebAssembly DatePicker](../getting-started/blazor-webassembly-visual-studio/) documentation pages for configuration specifications.

...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor DatePicker](https://www.syncfusion.com/blazor-components/blazor-datepicker) component inside the razor file.

---
layout: post
title: Week Number in Blazor DatePicker | Syncfusion®
description: Display ISO or culture-specific week numbers in the Blazor DatePicker with a leading column, configurable via WeekRule and FirstDayOfWeek.
platform: Blazor
control: DatePicker
documentation: ug
---

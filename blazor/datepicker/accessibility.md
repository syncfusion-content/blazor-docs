...
N> To demonstrate custom keyboard interaction, press the `t` key (lowercase) to move focus out of the DatePicker component. This is a user-defined example and not a built-in shortcut. For additional information about native event, [click](https://blazor.syncfusion.com/documentation/datepicker/native-events) here.

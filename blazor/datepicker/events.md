---
layout: post
title: Events in Blazor DatePicker | Syncfusion®
description: Handle Blazor DatePicker events such as ValueChange, OnOpen, OnClose, Navigated, and OnRenderDayCell to react to user input and custom rendering.
platform: Blazor
control: DatePicker
documentation: ug
---

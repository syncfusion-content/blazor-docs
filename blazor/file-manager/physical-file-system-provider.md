...
N> To learn more about file actions that can be performed with Physical file system provider, refer to this [link](https://github.com/SyncfusionExamples/ej2-aspcore-file-provider#key-features) When using a custom physical file provider in Syncfusion File Manager, installing a NuGet package is not required. The custom provider manages file operations independently, eliminating the need for additional dependencies.

...
Below is a screenshot illustrating the `NumericItemsCount` property in the FileManager component.
...
The screenshot below shows the page sizes dropdown in the FileManager.

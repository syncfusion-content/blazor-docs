...
description:  Learn to configure custom filtering in the Blazor File Manager component with clear steps and practical guidance.
platform: Blazor
...
In the following example, the Search String value **Downloads** is passed, and based on that, a search operation is performed in the Blazor File Manager using a button click.

...
description: Check out and learn about how to get started with the Blazor Signature Component in Blazor Web App and much more details.
platform: Blazor
control: Signature
documentation: ug
---
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor Signature component will render in your default web browser.

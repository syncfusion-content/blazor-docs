---
layout: post
title: Upgrade Blazor NuGet packages to the latest version | Syncfusion®
description: Learn here about how to upgrade Blazor NuGet packages to the latest version using the Package Manager UI, .NET CLI, or Package Manager Console.
platform: Blazor
control: Common
documentation: ug
---
...
```
dotnet add package Syncfusion.Blazor.Grid -v 32.1.25
```
...
3. By default, the latest version is installed. To install a specific version, use the -Version parameter as shown below.
    ...
    ```
    Update-Package Syncfusion.Blazor.Grid -Version 32.1.25
    ```

...
description: Learn how to get started with Blazor ProgressButton component in Blazor WebAssembly Application and much more details.
platform: Blazor
...
Add the Blazor ProgressButton component in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This renders the Blazor ProgressButton component in the default web browser.

...
description: Add the Blazor Stock Chart to a Blazor Web App using Visual Studio, Visual Studio Code, or the .NET CLI with step-by-step setup.
platform: Blazor
control: Stock Chart
documentation: ug
---

# Getting Started with Blazor Stock Chart

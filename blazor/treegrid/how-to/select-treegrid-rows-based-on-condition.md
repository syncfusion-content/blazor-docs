...
Rows with **Duration** column value is greater than 6 were selected. The row indexes are collected in the [RowDataBound](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.TreeGrid.TreeGridEvents-1.html#Syncfusion_Blazor_TreeGrid_TreeGridEvents_1_RowDataBound) event and selected during the [DataBound](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.TreeGrid.TreeGridEvents-1.html#Syncfusion_Blazor_TreeGrid_TreeGridEvents_1_DataBound) event.
...
@code {
    ...
    public async Task OnDataBound(object args)
    {
        ...
        await this.TreeGrid.SelectRowsAsync(SelectedNodeIndex.ToArray());
    }

    public void OnRowDataBound(RowDataBoundEventArgs<TreeData> args)
    {
        // Duration values greater than 6 are filtered by comparing the primary column values

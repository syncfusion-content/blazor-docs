...
ToolbarTemplate renders an SfToolbar inside the Syncfusion TreeGrid, binds boolean properties to each ToolbarItem’s Disabled attribute, invokes [RowSelected](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.TreeGrid.TreeGridEvents-1.html#Syncfusion_Blazor_TreeGrid_TreeGridEvents_1_RowSelected) to enable the buttons, and invokes [RowDeselected](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.TreeGrid.TreeGridEvents-1.html#Syncfusion_Blazor_TreeGrid_TreeGridEvents_1_RowDeselected) to disable them.

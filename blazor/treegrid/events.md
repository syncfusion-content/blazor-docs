...
[CommandClicked](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.html) event triggers when the command button is clicked. It provides the row data of the currently clicked row.

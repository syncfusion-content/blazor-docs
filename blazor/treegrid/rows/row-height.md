...
description: Check out here and learn more details about the Row Height in the Blazor Tree Grid component and much more details.
platform: Blazor
control: Tree Grid
documentation: ug
---
...
![Blazor TreeGrid with Custom Row Height](../images/blazor-treegrid-custom-row-height.webp)

...
<SfTreeGrid @ref="TreeGrid" DataSource="@TreeData" IdMapping="TaskID" ParentIdMapping="ParentID" Height="312" AllowSelection="true" TreeColumnIndex="1">
    <TreeGridEvents RowSelected="RowSelected" RowDeselected="RowDeselected" TValue="TaskData"></TreeGridEvents>
    ...
    <TreeGridColumns>
        ...
        <TreeGridColumn Field="Progress" HeaderText="Status" Width="110"></TreeGridColumn>
        <TreeGridColumn Field="StartDate" HeaderText="Start Date" Format="d" Type=Syncfusion.Blazor.Grids.ColumnType.Date Width="120" TextAlign="Syncfusion.Blazor.Grids.TextAlign.Right"></TreeGridColumn>
        <TreeGridColumn Field="EndDate" HeaderText="End Date" Format="d" Type=Syncfusion.Blazor.Grids.ColumnType.Date Width="110" TextAlign="Syncfusion.Blazor.Grids.TextAlign.Right"></TreeGridColumn>
    </TreeGridColumns>
</SfTreeGrid>
...
@code {
    ...
    public void RowDeselected(Syncfusion.Blazor.Grids.RowDeselectEventArgs<TaskData> args)
    {
        IsRowSelected = true;
    }
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BXVoCVrgRetAJjmC?appbar=true&editor=true&result=true&errorlist=true&theme=bootstrap5" %}
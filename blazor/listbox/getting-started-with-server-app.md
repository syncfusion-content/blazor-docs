...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable ListBox functionality.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [Blazor ListBox](https://www.syncfusion.com/blazor-components/blazor-listbox) component will render in your default web browser.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/VNLxNwjrLzbFMqLo?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor ListBox Component](./images/blazor-listbox.webp)" %}
...
3. [Styles and Appearances in Blazor ListBox Component](https://blazor.syncfusion.com/documentation/listbox/style-and-appearance)
...
The steps below help you to convert the **Blazor application** to the **Syncfusion Blazor application** via the **Visual Studio 2019 or later**:
...
1. Open your existing Blazor application or create a new Blazor application in Visual Studio 2019 or later.
...
|---|---|
| Syncfusion Blazor Server App | For .NET 6.0: {Project location}\Pages\_Layout.cshtml For .NET 5.0 or lower: {Project location}\Pages\_Host.cshtml 
 |

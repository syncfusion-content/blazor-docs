...
The steps below will assist you to upgrade the Syncfusion version in the Syncfusion Blazor application via Visual Studio 2019 or later:
...
1. Open the Syncfusion Blazor application that uses the Syncfusion component in the Visual Studio 2019 or later.

...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/LZrHjmWNJeqStbPX?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Displaying other Month Dates in Blazor Calendar](../images/blazor-calendar-other-month-dates.webp)" %}

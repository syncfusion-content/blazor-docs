...
# Getting Started with Smart Paste Button Component in Blazor Server App
...
Add the **Blazor Smart Paste Button** component with form components in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Blazor Smart Paste Button component in your default web browser.

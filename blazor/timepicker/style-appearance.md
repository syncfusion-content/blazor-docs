...
description: Customize Blazor TimePicker height, font size, and theme styles using CSS selectors and custom classes.
platform: Blazor
control: TimePicker
documentation: ug
---
...
The Blazor TimePicker's full-screen mode displays the popup element in full screen on mobile devices for better visibility and usability. This feature is available on mobile devices only and works in both landscape and portrait orientations. To enable it, set the [FullScreen](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Calendars.SfTimePicker-1.html#Syncfusion_Blazor_Calendars_SfTimePicker_1_FullScreen) property to `true`; the popup will then expand to occupy the entire screen on supported mobile devices.

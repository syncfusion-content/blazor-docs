...
Use the `AppendTo` property to render the TimePicker popup inside a specific container instead of the default `document.body`. This is useful when the component is placed inside dialogs, side panels, containers with overflow restrictions, or custom stacking contexts.
...
<div id="popupHost">
    <SfTimePicker TValue="TimeSpan?" AppendTo="@AppendTarget"></SfTimePicker>
</div>

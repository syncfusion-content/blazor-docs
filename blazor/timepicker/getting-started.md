...
This section briefly explains about how to include a [Blazor TimePicker](https://www.syncfusion.com/blazor-components/blazor-timepicker) component in the Blazor Server-Side and Client-Side application. Refer to the Getting Started with [Blazor Server-Side TimePicker](https://blazor.syncfusion.com/documentation/getting-started/blazor-server-side-visual-studio) and [Blazor WebAssembly TimePicker](https://blazor.syncfusion.com/documentation/getting-started/blazor-webassembly-visual-studio) documentation pages for configuration specifications.

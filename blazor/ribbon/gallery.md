...
Gallery items can be added using `<GalleryItem>` tag directive within the `Items` property of a group. Below example demonstrates how to configure properties such as `Content`, `IconCss`, `Disabled` to the gallery item.

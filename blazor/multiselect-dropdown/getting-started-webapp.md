---
layout: post
title: Get Started Blazor MultiSelect DropDown in Blazor Web App | Syncfusion
description: Checkout and learn the documentation for getting started with Blazor MultiSelect DropDown Components in Web App.
platform: Blazor

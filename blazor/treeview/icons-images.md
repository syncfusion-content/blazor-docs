---
layout: post
title: Icons and Images in Blazor TreeView Component | Syncfusion
...
# Icons and Images in Blazor TreeView Component

The Blazor TreeView component has the built-in option to customize each node's appearance with icons and images by mapping the **IconCss** and **ImageUrl** fields.

In the following example, the **IconCss** and **ImageUrl** properties is used.

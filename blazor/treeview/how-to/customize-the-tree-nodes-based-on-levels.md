...
description: Learn here all about how to customize the tree nodes based on levels in Blazor TreeView component and much more details.
platform: Blazor
control: TreeView
documentation: ug
---
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BXhIWNihKvBuqmZc?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" backgroundimage "[Customizing Nodes based on Levels in Blazor TreeView](../images/blazor-treeview-with-custom-nodes.webp)" %}
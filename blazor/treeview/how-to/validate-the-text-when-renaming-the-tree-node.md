...
description: Validate edited node text and cancel invalid renames with the NodeEdited event for safe input handling.
platform: Blazor
control: TreeView
documentation: ug
---

# How to validate text on rename in Blazor TreeView

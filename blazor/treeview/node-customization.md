...
## TreeView Navigation within Sidebar in Blazor TreeView Component

In the Blazor TreeView component, some applications need to navigate pages by using the Sidebar with the TreeView component. However, place the Sidebar on the MainLayout page and render the **@Body** as the main-content of the Sidebar on the MainLayout.razor page of the application.
The TreeView component's **NavigateUrl** property is used to navigate from one page to other pages with TreeView node selection.

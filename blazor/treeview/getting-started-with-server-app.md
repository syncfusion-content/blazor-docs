...
<body>
    ...
    //Blazor FileUpload Component script reference.
...
Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor TreeView component in the **~/Components/Pages/Home.razor** file. If an interactivity location as `per page/component`, define a render mode at the top of the `Home.razor` page.

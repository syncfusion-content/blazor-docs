---
layout: post
title: Filtering in Blazor TreeView Component | Syncfusion
description: Checkout and learn here all about filtering in Syncfusion Blazor TreeView component and more.
platform: Blazor
control: TreeView
documentation: ug
---

# Filtering in Blazor TreeView Component

There is no built-in filtering support in the Blazor TreeView Component. However, filtering the TreeView component's nodes can be achieved using an external TextBox component.

...
description: Checkout and learn about getting started with Blazor QueryBuilder component in Blazor WebAssembly Application with examples.
platform: Blazor
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This renders the Blazor Query Builder component in the default web browser.

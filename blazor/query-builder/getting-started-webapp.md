...
* Open a Razor file located in the **~/Components/Pages** (for example, **Home.razor**) and add the Blazor QueryBuilder component inside the razor file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor QueryBuilder component will render in your default web browser.

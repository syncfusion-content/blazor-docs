---
layout: post
title: Getting Started with QueryBuilder in Blazor Web App | Syncfusion®
description: Check out the documentation for getting started with Blazor QueryBuilder Components in Blazor Web App with examples.
platform: Blazor
...
Add the Blazor QueryBuilder component in the **~/Components/Pages/*.razor** file. If the interactivity location is set to `Per page/component` in the Web App, define a render mode at the top of the `~/Pages/*.razor` file. (For example, `InteractiveServer`, `InteractiveWebAssembly` or `InteractiveAuto`).

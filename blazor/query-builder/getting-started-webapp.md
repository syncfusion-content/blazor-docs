...
## Add Syncfusion&reg; Blazor QueryBuilder component

Add the Syncfusion&reg; Blazor QueryBuilder component in the **~Pages/.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/.razor` component, as follows:

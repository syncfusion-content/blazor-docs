...
description: Retrieve filtered records from Blazor Query Builder using GetFilteredRecordsAsync to efficiently process and display user-defined query results.
platform: Blazor
control: QueryBuilder
documentation: ug
---

# How to get filtered records in Blazor Query Builder
...
<SfButton CssClass="e-primary" @onclick="getData">Get Filtered Datasource</SfButton>

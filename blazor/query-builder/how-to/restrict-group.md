...
description: Checkout and learn here all about how to restrict the groups in Syncfusion Blazor QueryBuilder component and more.
platform: Blazor
...
The QueryBuilder allows to restrict the groups from creation based on group count. You can enable this feature by setting the [MaxGroupCount](https://help.syncfusion.com/cr/blazor#Syncfusion_Blazor_QueryBuilder_SfQueryBuilder_MaxGroupCount/Syncfusion.Blazor.html) property.

---
layout: post
title: How to restrict groups in Blazor Query Builder | Syncfusion
description: Restrict the number of condition groups users can create in Blazor Query Builder with MaxGroupCount.
platform: Blazor
control: QueryBuilder
documentation: ug
---

# How to restrict groups in Blazor Query Builder

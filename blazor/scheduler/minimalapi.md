...
4. Configure project name as **BlazorScheduler_MinimalAPI**
...
**Using .NET CLI:**
```bash
dotnet new blazor -n BlazorScheduler_MinimalAPI --interactivity Server
cd BlazorScheduler_MinimalAPI
```
...
namespace BlazorScheduler_MinimalAPI.Models;
...
using BlazorScheduler_MinimalAPI.Models;
using System.Net.Http.Json;

namespace BlazorScheduler_MinimalAPI.Services;
...
using BlazorScheduler_MinimalAPI.Components;
using BlazorScheduler_MinimalAPI.Models;
using BlazorScheduler_MinimalAPI.Services;
...
@using BlazorScheduler_MinimalAPI
@using BlazorScheduler_MinimalAPI.Components
@using BlazorScheduler_MinimalAPI.Components.Layout
@using BlazorScheduler_MinimalAPI.Models
@using BlazorScheduler_MinimalAPI.Services
@using Syncfusion.Blazor
...
<head>
    ...
    <link rel="stylesheet" href="@Assets["BlazorScheduler_MinimalAPI.styles.css"]" />
...
- `tailwind3.css` - Tailwind CSS theme (used in this example)

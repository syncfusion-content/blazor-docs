...
Register the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor service in the **Program.cs** file of your Blazor WebAssembly App. After declaring the `builder`, add it using the `builder.Services` configuration.

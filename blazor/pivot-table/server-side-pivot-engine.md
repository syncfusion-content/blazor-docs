...
description: Learn how the Blazor Pivot Table uses a server-side Pivot Engine to aggregate, filter, sort, and group data on the server, streaming only the current viewport to the client.
platform: Blazor
control: Pivot Table
documentation: ug
---
...
![Pivot Table demo using server-side pivot engine](./images/blazor-server-side-demo.webp)
...
![Server-Side Pivot Engine using collection](./images/blazor-server-side-with-collection-data.webp)
...
![Server-Side Pivot Engine with JSON data](./images/blazor-server-side-with-json-data.webp)
...
![Server-Side Pivot Engine using CSV data](./images/blazor-server-side-with-csv-data.webp)
...
![Server-Side Pivot Engine using DataTable](./images/blazor-server-side-with-data-table.webp)
...
![Server-Side Pivot Engine using ExpandoObject](./images/blazor-server-side-with-expandoobject.webp)
...
![Server-Side Pivot Engine using Dynamic Objects](./images/blazor-server-side-with-dynamic-object.webp)

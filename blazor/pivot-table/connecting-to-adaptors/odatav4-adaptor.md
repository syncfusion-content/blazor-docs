...
description: Learn how the Blazor Pivot Table binds to an OData V4 service through the ODataV4Adaptor, which loads the full data set for client-side aggregation and routes CRUD.
platform: Blazor
control: Pivot Table

...
description: Learn how the Blazor Pivot Table shows the raw, unaggregated records behind any aggregated value cell on double-click through the drill-through grid.
platform: Blazor
control: Pivot Table
documentation: ug
---

...
## Connecting a Microsoft SQL database to a Syncfusion&reg; Blazor Pivot Table
...
## Connecting a Microsoft SQL to a Syncfusion&reg; Blazor Pivot Table via Web API service

...
## Connecting a Oracle database to a Syncfusion&reg; Blazor Pivot Table
...
## Connecting a Oracle database to a Syncfusion&reg; Blazor Pivot Table via Web API service

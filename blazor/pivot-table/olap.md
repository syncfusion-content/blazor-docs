...
* When the pivot table's width and height are large, the loading data count in the current, previous, and next viewpoints (pages) will also increase, affecting performance.
## Data Binding

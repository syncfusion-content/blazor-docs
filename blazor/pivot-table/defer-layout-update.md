...
description: Learn how the Blazor Pivot Table defers layout recalculation in the field list until the user clicks Apply, improving performance on large reports.
platform: Blazor
control: Pivot Table
documentation: ug
---

...
N> In the example above, notice that the pivot data is kept in a separate **DataSource.cs** file. This separates the data management from the component logic, making your code more organized and maintainable. To access the **ProductDetails** data, using the **MyApp.Data** namespace into the **Index.razor** file.

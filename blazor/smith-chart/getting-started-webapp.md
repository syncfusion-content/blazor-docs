---
layout: post
title: Getting started with Smith Chart in Blazor Web App | Syncfusion®
description: Check out the documentation for getting started with Blazor Smith Chart Component in Blazor Web App.
platform: Blazor
control: Smith Chart
documentation: ug
---

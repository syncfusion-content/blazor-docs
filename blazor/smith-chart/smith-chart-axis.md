---
layout: post
title: Axis in Blazor Smith Chart | Syncfusion®
description: Customize horizontal and radial axes in the Blazor Smith Chart with label positioning, major and minor gridlines, and styled axis lines.
platform: Blazor
control: Smith Chart
documentation: ug
---

...
The Menu Bar component supports horizontal and vertical scrolling to render large Menu Bars and sub menus in an adaptive way. This can be achieved by enabling the [EnableScrolling](https://help.syncfusion.com/cr/blazor#Syncfusion_Blazor_Navigations_SfMenu_EnableScrolling/Syncfusion.Blazor.html) property and by restricting the corresponding Menu Bar/Sub Menu Bar size.
...
The following example demonstrates the use case of [HamburgerMenu](https://help.syncfusion.com/cr/blazor#Syncfusion_Blazor_Navigations_SfMenu_HamburgerMode/Syncfusion.Blazor.html) mode.

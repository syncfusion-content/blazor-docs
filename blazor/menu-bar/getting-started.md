...
To get started quickly with Menu Bar Component using Blazor, you can check on this video:
...
To add Blazor Menu Bar component in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), search for [Syncfusion.Blazor.Navigations](https://www.nuget.org/packages/Syncfusion.Blazor.Navigations/) and then install it.
...
* Now, add the Syncfusion Menu Bar component in razor file. Here, the Menu Bar component is added in the **~/Pages/Index.razor** file under the **~/Pages** folder.
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/VjrKjxsyVNsdusEp?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->

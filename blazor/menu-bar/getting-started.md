---
layout: post
title: Getting Started with Menu Bar in Blazor WASM App | Syncfusion
...
# Getting Started with Menu Bar in Blazor WASM App
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **~wwwroot/index.html** file to enable Blazor Menu Bar functionality.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rNBxtxgZrzAhyvDQ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor MenuBar Component](./images/blazor-menubar.webp)" %}
...
4. [Icons and submenu Items in Blazor Menu Bar Component](https://blazor.syncfusion.com/documentation/menu-bar/icons)
...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Menu Bar](https://www.syncfusion.com/blazor-components/blazor-menu-bar) component inside the razor file.

...
description: Check out the documentation for getting started with Blazor Menu Bar Components in Web App and much more details.
platform: Blazor
control: Menu Bar
documentation: ug
---
...
Add the Blazor Menu Bar component in the **~/Components/Pages/*.razor** file. If the interactivity location is set to `Per page/component` in the Web App, define a render mode at the top of the `~/Pages/*.razor` file. (For example, `InteractiveServer`, `InteractiveWebAssembly` or `InteractiveAuto`).

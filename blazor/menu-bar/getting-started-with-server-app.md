...
description: Check out the documentation for getting started with Blazor Menu Bar Components in Server App and much more details.
platform: Blazor
control: Menu Bar
documentation: ug
---
...
Add the Blazor Menu Bar component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.

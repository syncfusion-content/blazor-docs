...
> [Refer to the section](populate-data#data-binding) for more information on data binding.
...
> [View Sample in GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/Maps).

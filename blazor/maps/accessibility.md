---
layout: post
title: Accessibility in Blazor Map | Syncfusion®
description: Learn how the Syncfusion Blazor Map meets WCAG 2.2, Section 508, WAI-ARIA, and screen reader accessibility standards with keyboard navigation support.
platform: Blazor
control: Maps
documentation: ug
---

# Accessibility in Blazor Map

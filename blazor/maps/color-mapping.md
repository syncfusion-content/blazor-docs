...
Equal color mapping applies the color to the shapes of the Maps when the [Value](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsColorMapping.html#Syncfusion_Blazor_Maps_MapsColorMapping_Value) property of [MapsShapeColorMapping](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsShapeColorMapping.html) class matches with the values provided in the data source.
...
> The following example shows how to apply desaturation color mapping to shapes with the data source "**PopulationDetails**" that is available in the [Range color mapping](#range-color-mapping) section.
...
Multiple colors can be added to the color mapping which can be used as gradient effect to a specific shape based on the ranges in the data source. By using the [Color](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsColorMapping.html#Syncfusion_Blazor_Maps_MapsColorMapping_Color) property of [MapsShapeColorMapping](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsShapeColorMapping.html) class, any number of colors can be set to the shapes as a gradient.

> The following example demonstrates how to use multiple colors in color mapping with the data source  "**PopulationDetails**" that is available in the [Range color mapping](#range-color-mapping) section.
...
Color mapping can be applied to the shapes in the Maps which does not match color mapping criteria such as range or equal values using the  [Color](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsColorMapping.html#Syncfusion_Blazor_Maps_MapsColorMapping_Color) property of [MapsShapeColorMapping](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Maps.MapsShapeColorMapping.html) class.

> The following example shows how to set the color for items excluded from the color mapping with the data source  "**PopulationDetails**" that is available in the [Range color mapping](#range-color-mapping) section.
...
![Color mapping for bubbles](./images/Colormapping/Colormapping-bubbles.PNG)
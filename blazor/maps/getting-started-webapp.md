---
layout: post
title: Getting Started with Blazor Map in Blazor Web App | Syncfusion®
description: Learn how to get started with the Syncfusion Blazor Map control in a Blazor Web App. Explore setup, features, examples, and customization options.
platform: Blazor
component: Maps
documentation: ug
---

# Getting Started with Blazor Map in Blazor Web App
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Maps functionality.

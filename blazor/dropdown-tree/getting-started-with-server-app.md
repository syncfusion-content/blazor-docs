---
layout: post
title: Getting Started with Blazor Dropdown Tree in Blazor Server App | Syncfusion®
...
Open a Razor file located in the **~/Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Dropdown Tree](https://www.syncfusion.com/blazor-components/blazor-dropdowntree) component inside the razor file.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/VjVnNRBOAyXqHacF?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Dropdown Tree Component](./images/blazor-dropdowntree-component.webp)" %}

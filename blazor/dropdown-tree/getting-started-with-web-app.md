---
layout: post
title: Getting Started with Syncfusion Dropdown Tree Component in Blazor Web App
...
N> If the **Interactive Render Mode** is set to `WebAssembly` or `Auto`, register the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor service in the **Program.cs** files of both the server and client projects in your Blazor Web App.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Dropdown Tree component in the default web browser.

...
This section provides information about deploying a Blazor Web applications with the Blazor components to Azure App Service.
...
![Create new resource](../images/create-new-resource.webp)

* Select **Web App** Azure application service.

![Select web app](../images/web-app.webp)
...
![Publish menu](../images/publish-menu.webp)

* Select **Azure** as the target and **Azure App Service (Windows)**  as the specific target.

![Publish target](../images/publish-target.webp)

![Publish specific target](../images/publish-specific-target.webp)
...
![Created azure app service](../images/created-azure-resource.webp)

![Publish App](../images/publish-azure.webp)
...
![Publish target](../images/target-import-profile.webp)
...
![Output-Azure](../images/output-azure.webp)

...
description: Comprehensive user guide for migrating Syncfusion WPF controls to Syncfusion Blazor components on .NET 8+, including setup, configuration, and component examples.
platform: Blazor
component: Common
documentation: ug
---

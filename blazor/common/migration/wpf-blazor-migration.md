...
description: Step-by-step guide for migrating Syncfusion WPF components to Blazor using .NET 8 or later.
platform: Blazor
component: Common
documentation: ug
---
...
The shared setup below applies to all six Syncfusion components and covers the common configuration required before moving on to component-specific migration steps.

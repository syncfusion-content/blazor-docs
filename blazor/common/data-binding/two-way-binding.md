---
layout: post
title: Two-way Data Binding in Blazor Applications | Syncfusion®
...
# Two-way Data Binding in Blazor Applications
...
To enable two-way binding on Blazor components, use `@bind-Value`. In the following example, the `SfTextBox` component is bound to the C# `textValue` property. When the textbox loses focus, the bound field is updated.

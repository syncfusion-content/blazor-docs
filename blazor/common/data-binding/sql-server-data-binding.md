...
description: Learn about consuming data from SQL Server using Microsoft SQL Client, binding it to Blazor Component, and performing CRUD operations
platform: Blazor
...
This topic gives a clear idea about how to consume data from [SQL Server](https://learn.microsoft.com/en-us/sql/sql-server/?view=sql-server-ver15) using Microsoft SQL Client, bind it to a Component, and perform CRUD operations.
...
In previous steps, you have successfully configured the Blazor package in the application. Now, you can add the grid component to the to the `.razor` page inside the `Pages` folder.
...
Let’s see how to perform CRUD operation using SQL server data with Blazor DataGrid component

...
* **An unhandled exception has occurred. See browser dev tools for details**
    ...
    **Solution:**
    ...
    Check the console error with the following topics to resolve the issue or report us the console error through our [support ticket](https://support.syncfusion.com/support/tickets).

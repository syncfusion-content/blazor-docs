...
The following table demonstrates the list of Syncfusion&reg; Blazor components that are supported with state persistence and describes the list of properties stored in the `localStorage`.

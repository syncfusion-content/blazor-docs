...
* For **.NET 8 and.NET 9 in Blazor Web App** using any render mode (Server, WebAssembly, or Auto), reference scripts in `~/Components/App.razor` file.
* For **Blazor WebAssembly standalone app** , reference scripts in `~/wwwroot/index.html` file.

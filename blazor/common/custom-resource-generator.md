...
2. Now, manually add the custom interop script and styles in the Blazor App.
    * For **Blazor Web App**, reference custom interop script and styles in `~/Components/App.razor` file.
    * For **Blazor WASM App**, reference custom interop script and styles in `~/wwwroot/index.html` file.
    * For **Blazor Server App**, reference custom interop and styles script in

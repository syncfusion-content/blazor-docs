...
description: Check out and learn about customization in the Syncfusion Blazor Chip component, including predefined styles, leading avatars/icons, trailing icons, outline style, and chip templates.
platform: Blazor
control: Chip
documentation: ug
---

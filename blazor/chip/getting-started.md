...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Chips](https://www.syncfusion.com/blazor-components/blazor-chips) component inside the razor file.

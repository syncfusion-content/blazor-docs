...
description: Checkout and learn about getting started with Blazor Chip component in Blazor WebAssembly Application.
platform: Blazor
control: Chip
documentation: ug
---
...
## Add Blazor Syncfusion<sup style="font-size:70%">&reg;</sup> Chip component

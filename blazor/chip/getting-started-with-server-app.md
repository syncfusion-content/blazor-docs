---
layout: post
title: Getting Started with Blazor Chip in Server App | Syncfusion®
...
Add the Blazor Chip component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.

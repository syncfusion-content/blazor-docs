...
description: Check out and learn about how to get started with the Blazor Chips Component in a Blazor Server App.
platform: Blazor
component: Chips
documentation: ug
---
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor Chips component will render in your default web browser.

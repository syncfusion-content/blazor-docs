---
layout: post
title: Getting Started with Blazor Chips in Blazor Web App | Syncfusion®
...
# Getting Started with Blazor Chips in Blazor Web App
...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Chips](https://www.syncfusion.com/blazor-components/blazor-chips) component inside the `.Client` project Razor file.

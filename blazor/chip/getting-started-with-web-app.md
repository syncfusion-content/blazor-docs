...
description: Check out how to get started with the Syncfusion Blazor Chip component in a Blazor Web App, including installing packages, configuring render modes, registering services, adding resources, and rendering chips.
platform: Blazor
control: Chip
documentation: ug
---
...
Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Chip component in a `.razor` file inside the `Pages` folder. If the interactivity location is `Per page/component` in the web app, define a render mode at the top of the component as follows:

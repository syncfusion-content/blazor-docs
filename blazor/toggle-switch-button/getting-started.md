...
To add Blazor Toggle Switch Button component in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), search for [Syncfusion.Blazor.Buttons](https://www.nuget.org/packages/Syncfusion.Blazor.Buttons) and then install it.
...
* Now, add the Syncfusion Toggle Switch Button component in razor file. Here, the Toggle Switch Button component is added in the **~/Pages/Index.razor** file under the **~/Pages** folder.
...
N> You can also explore our [Blazor Toggle Switch Button example](https://blazor.syncfusion.com/demos/buttons/toggle-switch-button) that shows you how to render and configure the Toggle Switch Button.

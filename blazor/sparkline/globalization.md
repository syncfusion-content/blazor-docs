---
layout: post
title: Globalization in Blazor Sparkline Charts | Syncfusion®
description: Globalize the Blazor Sparkline Charts number, date, and time values with the Format property, such as currency in the Deutsch culture, using tooltip settings.
platform: Blazor
control: Sparkline Charts
documentation: ug
---

# Globalization in Blazor Sparkline Charts

---
layout: post
title: Getting Started With Blazor DropDown List in Web Assembly | Syncfusion
description: Checkout and learn about getting started with Blazor WebAssembly and Blazor DropDown List component in Visual Studio and much more.
platform: Blazor
control: DropDown List
documentation: ug
---

# Blazor DropDown List Component in WebAssembly App using Visual Studio

This article provides a step-by-step instructions for building Blazor WebAssembly App with Blazor DropDown List component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion Blazor DropDown List component will be rendered in the default web browser.

![Blazor bind DropDown List](./images/blazor-dropdownlist-data-binding.png)

> You can also explore our [Blazor DropDown List example](https://blazor.syncfusion.com/demos/dropdown-list/default-functionalities) to understand how to to bind data to the DropDown List.
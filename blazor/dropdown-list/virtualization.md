...
DropDownList has been provided virtualization to improve the UI performance for a large amount of data when [EnableVirtualization](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.DropDowns.SfDropDownList-2.html#Syncfusion_Blazor_DropDowns_SfDropDownList_2_EnableVirtualization) is true. 
...
![Blazor DropDownList with virtualization](./images/virtualization/blazor_dropdownlist_virtualization-local-data.gif)
...
![Blazor DropDownList with virtualization](./images/virtualization/blazor_dropdown_virtualization-remote-data.gif)

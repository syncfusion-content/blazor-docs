...
![Blazor Dropdown List in read-only mode](./images/style/blazor_dropdown_readonly-mode.webp)
...
![Blazor Dropdown List in disabled state](./images/style/blazor_dropdown_disabled-state.webp)
...
![Blazor Dropdown List styled via CssClass](./images/style/blazor_dropdown_cssclass-property.webp)
...
![Blazor Dropdown List with customized disabled text color](./images/style/blazor_dropdown_disable-text-color.webp)

## Show the custom icon in dropdown icon

Customize the dropdown [icon](https://ej2.syncfusion.com/documentation/appearance/icons#material) by targeting its CSS class `.e-ddl-icon::before`, which indicates the icon element displayed within the Blazor Dropdown List component, and set the desired icon to the `content` property.
...
![Blazor Dropdown List with customized dropdown icon](./images/style/blazor_dropdown_dropdown-icon.webp)
...
![Blazor Dropdown List with dropdown icon using CssClass](./images/style/blazor_dropdown_dropdown-icon.webp)

## Customizing the appearance of container element

Customize the appearance of the container element within the Blazor Dropdown List component by targeting its CSS class `.e-input`, which indicates the parent element of the input, and allows you to apply any desired styles to the component.
...
![Blazor Dropdown List container appearance customized](./images/style/blazor_dropdown_appearance-of-container.webp)

## Customizing the dropdown icon’s color

Customize the dropdown [icon](https://ej2.syncfusion.com/documentation/appearance/icons#material) by targeting its CSS class `.e-ddl-icon.e-icons`, which indicates the icon element displayed within the Blazor Dropdown List component, and setting the desired color to the `color` property.
...
![Blazor Dropdown List with custom icon color](./images/style/blazor_dropdown_icon-color.webp)
...
![Blazor Dropdown List with custom focus color](./images/style/blazor_dropdown_focus-color.webp)
...
![Blazor Dropdown List outline theme focus color](./images/style/blazor_dropdown_focusing-color-of-outline-theme.webp)
...
![Blazor Dropdown List rendered with outline theme](./images/style/blazor_dropdown_outline-theme.webp)
...
![Blazor Dropdown List with custom item state colors](./images/style/blazor_dropdown_outline-theme.webp)
...
![Blazor Dropdown List with customized popup appearance](./images/style/blazor_dropdown_outline-theme.webp)
...
![Blazor Dropdown List with custom HTML attributes](./images/style/blazor_dropdown_html-attributes.webp)
...
![Blazor Dropdown List with input attributes](./images/style/blazor_dropdown_input-attributes-propety.webp)
...
![Blazor Dropdown List with custom font family](./images/style/blazor_dropdown_font-family.webp)
...
![Blazor Dropdown List with tooltip on items](./images/style/blazor-dropdownlist-tooltip.webp)
...
![Blazor Dropdown List with input tooltip](./images/style/blazor_dropdown_default-tooltip.webp)
...
![Blazor Dropdown List with custom selected item opacity](./images/style/blazor_dropdown_opacity-style.webp)
...
![Blazor Dropdown List with custom popup height](./images/style/blazor_dropdown_height.webp)
...
![Blazor Dropdown List with custom popup width](./images/style/blazor_dropdown_width-popup-width.webp)
...
![Blazor Dropdown List with Popup Width](./images/style/blazor_dropdown_disable-listitem.webp)
...
![Adding attributes to list items in DropDownList](./images/style/blazor_dropdown_add-attribute-listitem.webp)
...
![Blazor Dropdown List displayed inside a tab view](./images/style/blazor_dropdown-in-tabview.webp)
...
![Blazor Dropdown List displayed inside a dialog](./images/style/blazor_dropdown_inside-dialog.gif)
...
![Show or hide spinner in Blazor Dropdown List](./images/style/blazor_dropdown_readonly-mode.webp)
...
Integrate the Syncfusion&reg; Blazor Tooltip component with the Syncfusion&reg; Blazor [Button](https://blazor.syncfusion.com/documentation/button/getting-started) component in the ~/Pages/Index.razor file.

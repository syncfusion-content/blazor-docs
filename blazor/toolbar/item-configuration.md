...
N>you can refer [here](https://blazor.syncfusion.com/documentation/appearance/icons#icon-integration-in-button-component) to integrate the Syncfusion&reg; icons in toolbar component.
...
3. **Input**: Creates an input element that is applicable to template rendering with Syncfusion&reg; controls like DropDownList, AutoComplete, etc.

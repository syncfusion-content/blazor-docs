...
description: Checkout and learn about getting started with Blazor Toolbar component in Blazor Server App and Blazor WebAssembly App.
platform: Blazor
control: Toolbar
documentation: ug
---
...
This section briefly explains about how to include [Blazor Toolbar](https://www.syncfusion.com/blazor-components/blazor-toolbar) component in your Blazor Server App and Blazor WebAssembly App using Visual Studio.

To get started quickly with Blazor Toolbar, check on this video or [GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/Toolbar) sample.
...
Add the Syncfusion&reg; Blazor Toolbar component in the **~/Pages/Index.razor** file.

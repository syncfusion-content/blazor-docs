---
layout: post
title: Stamp annotations in Blazor SfPdfViewer2 Component | Syncfusion
description: Checkout and learn here all about stamp annotations in Syncfusion Blazor SfPdfViewer2 component and more.
platform: Blazor
control: SfPdfViewer2
documentation: ug
---

# Stamp annotations in Blazor SfPdfViewer2 Component

The SfPdfViewer2 control provides options to add, edit, delete and rotate the following stamp annotation in the PDF documents:
...
In the pan mode, if the stamp annotation mode is entered, the SfPdfViewer2 control will switch to text select mode.
...
@code
{
    ...
    public void stampClicked(ClickEventArgs args)
    {
        pdfViewerCustomStamps = new List<PdfViewerCustomStamp>()
        {
            ...
            {
                //Defines the custom stamp name to be added in the stamp menu of the SfPdfViewer2 toolbar.
                CustomStampName = "Stamp",
                //Defines the custom stamp images source to be added in the stamp menu of the SfPdfViewer2 toolbar.
    ...
    {
        //Navigate to next page of the PDF document loaded in the SfPdfViewer2.
        viewer.GoToNextPageAsync();
    }

    public void downloadDocument(ClickEventArgs args)
    {
        //Downloads the PDF document being loaded in the SfPdfViewer2.

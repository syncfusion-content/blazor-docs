...
This article provides a step-by-step instructions for building `Blazor Web App` with `Blazor Predefined Dialogs` component using [Visual Studio](https://visualstudio.microsoft.com/vs/).

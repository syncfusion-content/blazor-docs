...
PM> NuGet\Install-Package Syncfusion.Blazor.Popups -Version {{ site.releaseversion }}
...
Now, register the Syncfusion Blazor Service and Sycnfusion Dialog Service in the Blazor Server App or Blazor WebAssembly App. 
...
* For the **.NET 7** app, add the Syncfusion bootstrap5 theme in the `<head>` of the **~/Pages/_Host.cshtml** file.
...
* For the **.NET 7** app, refer to the script in the `<head>` of the **~/Pages/_Host.cshtml** file.

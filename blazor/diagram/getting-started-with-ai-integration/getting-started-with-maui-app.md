---
layout: post
title: Getting Started with AI integration in Blazor MAUI App | Syncfusion
description: Checkout and learn about the documentation for getting started with AI integration in Blazor MAUI App.
platform: Blazor
control: Diagram Component
documentation: ug
---

# Getting Started with AI integration in a Blazor MAUI App
...
**To configure the AI service, add the following settings to the ~/MauiProgram.cs file.**
...
* A send button that calls your AI service to generate a mind map based on the prompt.

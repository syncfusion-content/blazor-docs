...
```
## AutoScroll 
The auto-scroll feature automatically scrolls the diagram whenever the node is moved beyond its boundaries.So that it is always visible during dragging, resizing, and multiple selection operations.
...
The ScrollLimit property of scroll settings class helps to limit the auto scrolling area.

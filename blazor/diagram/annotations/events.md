...
* While selecting annotation elements, the following events can be used to do customization.
* When selecting or unselecting annotations, the following events are triggered.
...
* While dragging an annotation through interaction, the following events can be used to do customization.
* When dragging an annotation, the following events are triggered.
...
* While resizing an annotation during interaction, the following events can be used to do customization.
* When resizing an annotation, the following events are triggered.
...
* While rotating an annotation during interaction, the following events can be used to do customization.
* When rotating an annotation, the following events are triggered.

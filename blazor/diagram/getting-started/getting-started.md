...
In this section, we'll guide you through the process of adding Syncfusion's Blazor Diagram component to your Blazor Server app or Blazor WebAssembly. We'll break it down into simple steps to make it easy to follow. you can create Balzor Server[../getting-started/server-side-application] or WeAssembly App[../getting-started/web-assembly-application]. 

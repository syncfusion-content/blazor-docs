...
| -------- | -------- |
|Horizontal| It is used to flip the node to be mirrored across the horizontal axis.|
|Vertical| It is used to flip the node to be mirrored across the vertical axis.|
|Both| It is used to flip the node to be mirrored across the horizontal and vertical axes.|

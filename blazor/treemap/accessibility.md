...
description: Learn how to make the Blazor TreeMap accessible with WAI-ARIA roles, screen-reader support for labels and legends, and accessibility validation.
platform: Blazor
control: TreeMap
documentation: ug
---
...
The Blazor TreeMap component follows the [WAI-ARIA](https://www.w3.org/WAI/ARIA/apg/patterns/) patterns to ensure accessibility compliance. The following `WAI-ARIA` attributes are used in the TreeMap component:
...
## Screen reading in the Blazor TreeMap

The Blazor TreeMap component ensures that all users, regardless of ability, can access content via screen reading. The following TreeMap elements will be read aloud using screen reading software, such as Narrator for Windows.
...
The Blazor TreeMap component's accessibility levels are validated using the [axe-core](https://www.nuget.org/packages/Deque.AxeCore.Playwright) automated testing tool.

---
layout: post
title: Getting Started | Blazor Input Mask in Blazor WASM App | Syncfusion
...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Input Mask](https://www.syncfusion.com/blazor-components/blazor-input-mask) component inside the razor file.

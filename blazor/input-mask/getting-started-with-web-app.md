---
layout: post
title: Getting Started with Blazor Input Mask in Web App | Syncfusion
description: Learn how to get started with the Syncfusion Blazor Input Mask in a Blazor Web App with installation and setup steps.
platform: Blazor
...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Input Mask](https://www.syncfusion.com/blazor-components/blazor-input-mask) component inside the `.Client` project Razor file.

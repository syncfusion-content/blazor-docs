...
Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor components are compatible with .NET Core 5.0 Preview 6 and it requires Visual Studio 16.7 Preview 1 or later.
...
3. The Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor package will be installed in the project, once the installation process is completed.
...
* [Getting Started with Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor for Server-Side in Visual Studio 2019 Preview](https://blazor.syncfusion.com/documentation/getting-started/blazor-server-side-visual-studio)

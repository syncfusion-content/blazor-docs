...
# Getting Started with Blazor DateRangePicker in Blazor WASM App
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **~wwwroot/index.html** file to enable Blazor DateRangePicker functionality.
...
Add the [Blazor DateRangePicker](https://www.syncfusion.com/blazor-components/blazor-daterangepicker) component in the **~/Pages/*.razor** (for example, **Home.razor**) file.

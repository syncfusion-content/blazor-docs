---
layout: post
title: Getting started with Syncfusion Blazor Media Query Web App in Visual Studio
...
# Getting Started with Blazor Media Query Web App

This article provides a step-by-step instructions for building `Blazor Web App` with `Blazor Media Query` component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
Add the Syncfusion Blazor Media Query component in the **~/Components/Pages/*.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/*.razor` component, as follows:

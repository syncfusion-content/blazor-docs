...
## Install Syncfusion Blazor Layout NuGet in the App
...
* Press F5 to run the application. Then, the Syncfusion Blazor Media Query component will be rendered in the default web browser.

...
This section briefly explains about how to include `Blazor Media Query` component in your Blazor WebAssembly App using Visual Studio and Visual Studio Code.

---
layout: post
title: Getting started Blazor Media Query in Blazor Server App | Syncfusion®
description: Check out the documentation for getting started with Blazor Media Query Components in Blazor Server App.
platform: Blazor
control: Media Query
documentation: ug
---

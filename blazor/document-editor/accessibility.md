...
|<kbd>End</kbd> | <kbd>Fn</kbd> + <kbd>→</kbd> | Moves the cursor position to the end of a line.|
...
|<kbd>Ctrl</kbd> + <kbd>End</kbd> | <kbd>⌘</kbd> + <kbd>Fn</kbd> + <kbd>→</kbd> | Moves the cursor position to the end of a document.|
...
|<kbd>Shift</kbd> + <kbd>End</kbd> | <kbd>⇧</kbd> + <kbd>Fn</kbd> + <kbd>→</kbd> | Extends Selection to the end of a line.|
...
|<kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>End</kbd> | <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>Fn</kbd> + <kbd>→</kbd> | Extends selection to the end of a document.|

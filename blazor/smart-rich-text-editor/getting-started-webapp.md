...
## Install Blazor Smart Rich Text Editor and Themes NuGet
...
Now, register the Blazor Service in the **~/Program.cs** file of your Blazor Web App.
...
Add the **Blazor Smart Rich Text Editor** component in the **~/Components/Pages/Home.razor** or any other page file.
...
![Blazor Smart Rich Text Editor - Output](images/smart-rich-text-editor-overview.webp)

...
description: Learn how to configure OpenAI service for Syncfusion Blazor Smart Rich Text Editor component.
platform: Blazor
...
> **Note**: Model availability and names may change. Refer to [OpenAI documentation](https://platform.openai.com/docs/models) for current options.
...
- Verify model name is correct (check [model list](https://platform.openai.com/docs/models))

---
layout: post
title: Accessibility in Blazor File Upload | Syncfusion
description: Learn how Blazor File Upload supports accessibility standards, keyboard navigation, screen readers, and ARIA attributes.
platform: Blazor
control: File Upload
documentation: ug
---

# Accessibility in Blazor File Upload
...
The following are the standard keys that work in the Blazor File Upload component:
...
The accessibility compliance of the Blazor File Upload component is shown in the following sample. Open the [sample](https://blazor.syncfusion.com/accessibility/uploader) in a new window to evaluate the accessibility of the Blazor File Upload component with accessibility tools.

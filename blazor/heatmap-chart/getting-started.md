...
[Getting Started with Web App for Blazor HeatMap Chart Component in Visual Studio](https://blazor.syncfusion.com/documentation/heatmap-chart/getting-started-with-web-app)

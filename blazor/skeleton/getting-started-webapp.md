...
description: Check out how to get started with the Syncfusion Blazor Skeleton component in a Blazor Web App, including installing packages, configuring render modes, registering services, adding resources, and rendering skeleton placeholders.
platform: Blazor
control: Skeleton
documentation: ug
---

...
description: Check out and learn how to get started with the Blazor ComboBox component in a Blazor WebAssembly App.
platform: Blazor
component: ComboBox
documentation: ug
---

# Getting Started with Blazor ComboBox Component in Blazor WASM App
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor ComboBox component will render in your default web browser.

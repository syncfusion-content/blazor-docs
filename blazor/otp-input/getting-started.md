...
description: Learn how to get started with the Blazor OTP Input component in a Blazor WebAssembly application with installation and configuration steps.
platform: Blazor
control: OTP Input
documentation: ug
---
...
Add the Blazor OTP Input component in the **~/Pages/Index.razor** file.

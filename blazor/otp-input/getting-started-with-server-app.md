---
layout: post
title: Getting Started with Blazor OTP Input in Blazor Server App | Syncfusion®
description: Learn how to get started with the Blazor OTP Input component in a Blazor Server App with installation and configuration steps.
platform: Blazor
control: OTP Input
documentation: ug
---
...
Add the Blazor OTP Input component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Blazor OTP Input component in the default web browser.

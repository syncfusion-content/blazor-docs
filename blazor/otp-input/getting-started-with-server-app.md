---
layout: post
title: Getting Started with Blazor OTP Input in Server App | Syncfusion
description: Learn how to get started with the Syncfusion Blazor OTP Input in a Blazor Server app with installation and setup steps.
platform: Blazor
control: OTP Input
documentation: ug
---

# Getting Started with Blazor OTP Input in Blazor Server App

This section briefly explains how to include the [Blazor OTP Input](https://www.syncfusion.com/blazor-components/blazor-otp-input) component in a Blazor Server App using [Visual Studio](https://visualstudio.microsoft.com/vs/), [Visual Studio Code](https://code.visualstudio.com/), and the [.NET CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/).
...
Open a Razor file located in the **~/Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor OTP Input](https://www.syncfusion.com/blazor-components/blazor-otp-input) component inside the razor file.

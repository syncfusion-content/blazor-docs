---
layout: post
title: Getting started with Syncfusion Blazor Splitter Web App
...
# Getting Started with Blazor Splitter Web App

This article provides a step-by-step instructions for building `Blazor Web App` with [Blazor Splitter](https://www.syncfusion.com/blazor-components/blazor-splitter) component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
## Add Syncfusion Blazor Splitter component

Add the Syncfusion Blazor Splitter component in the **~/Components/Pages/*.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/*.razor` component, as follows:

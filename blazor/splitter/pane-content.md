...
The plain text can be added as a pane contents using either inner HTML or [`Content`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Layouts.SplitterPane.html#Syncfusion_Blazor_Layouts_SplitterPane_Content) API

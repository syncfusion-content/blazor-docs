...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Splitter](https://www.syncfusion.com/blazor-components/blazor-splitter) component inside the razor file.

...
The `Exporting` event allows users to customize the exported chart before it is generated. The `ChartExportEventArgs` class provides options for customizing the exported chart and specifies the following properties available for the Exporting event of the chart component:

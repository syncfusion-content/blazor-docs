---
layout: post
title: Sorting in Blazor Charts | Syncfusion®
description: Sort Blazor Charts data in ascending or descending order by setting the ChartSorting PropertyName to the Y-axis field.
platform: Blazor
control: Charts
documentation: ug
---

# Sorting in Blazor Charts

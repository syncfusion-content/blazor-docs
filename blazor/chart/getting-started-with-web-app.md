---
layout: post
title: Getting Started with Blazor Chart Component in WebApp | Syncfusion®
...
Register the Blazor service in the **Program.cs** file of your Blazor Web App. This step enables the components to work in your application.
...
Add the Blazor Chart component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component` in the Web App, define a render mode at the top of the `~Pages/Home.razor` file. (For example, `InteractiveServer`, `InteractiveWebAssembly` or `InteractiveAuto`).

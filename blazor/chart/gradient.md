...
A linear gradient blends colors along a straight path from a defined start point to an end point. Configure it by adding [ChartLinearGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartLinearGradient.html) inside the target element (`ChartSeries`, `ChartTrendline`, or `ChartIndicator`) and define one or more color stops that control how colors transition across the gradient. Set the start and end positions of the gradient using `X1`, `Y1`, `X2`, and `Y2` properties. The color stop values such as `Offset`, `Color`, `Opacity`, `Lighten`, and `Brighten` are set using the [ChartGradientColorStop](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartGradientColorStop.html) property.
...
Apply a linear gradient to a series by adding [ChartLinearGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartLinearGradient.html) inside the target `ChartSeries`. The same gradient is applied to the series markers, legend symbol, and tooltip marker for visual consistency.

```cshtml

@using Syncfusion.Blazor.Charts

@* Initialize the Chart to display monthly sales revenue using Column series *@
<SfChart Title="Monthly Sales Performance">
    ...
    <ChartSeriesCollection>
        <ChartSeries Name="Sales" Type="ChartSeriesType.Column" DataSource="@SalesData" XName="Month" YName="Amount">
            @* Series Linear Gradient: applied to the series fill, markers, and legend symbol *@
...
Apply a linear gradient to a trendline by adding [ChartLinearGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartLinearGradient.html) inside the target `ChartTrendline`.
...
Apply a linear gradient to a technical indicator by adding [ChartLinearGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartLinearGradient.html) inside the target `ChartIndicator`.
...
A radial gradient blends colors outward from a central point, creating a circular or elliptical color progression. Configure it by adding [ChartRadialGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartRadialGradient.html) inside the target element (`ChartSeries`, `ChartTrendline`, or `ChartIndicator`) and define one or more color stops to control how colors transition from the center to the outer edge. Set the gradient's center, optional focal point, and radius using [ChartRadialGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartRadialGradient.html) properties. The color stop values such as `Offset`, `Color`, `Opacity`, `Lighten`, and `Brighten` are set using the [ChartGradientColorStop](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartGradientColorStop.html) property.
...
- `Fx` - Sets the normalized horizontal focal point from which the gradient appears to originate (0 to 1). Omit to use `Cx`.
- `Fy` - Sets the normalized vertical focal point (0 to 1). Omit to use `Cy`.
...
Apply a radial gradient to a series by adding [ChartRadialGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartRadialGradient.html) inside the target `ChartSeries`. The same gradient is applied to the series markers, legend symbol, and tooltip marker for visual consistency.
...
<SfChart Title="Monthly Sales Performance">
    ...
    <ChartSeriesCollection>
        <ChartSeries Name="Sales" Type="ChartSeriesType.Column" DataSource="@SalesData" XName="Month" YName="Amount">
            @* Series Radial Gradient: applied to the series fill, markers, and legend symbol *@
...
Apply a radial gradient to a trendline by adding [ChartRadialGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartRadialGradient.html) inside the target `ChartTrendline`. The same `X1`/`Y1`/`X2`/`Y2` properties used for the linear gradient are not available here; instead, use `Cx`, `Cy`, `Fx`, `Fy`, and `R` to position the gradient.
...
<SfChart Title="Retail Orders Processed">
    ...
    <ChartSeriesCollection>
        <ChartSeries DataSource="@OrdersData" XName="Month" YName="Orders" Type="ChartSeriesType.Spline">
            ...
            <ChartTrendlines>
                <ChartTrendline Type="TrendlineTypes.Linear" Width="3" Name="Trend">
                    @* Trendline Radial Gradient: applied to trendline stroke *@
                    <ChartRadialGradient Cx="0.5" Cy="0.5" Fx="0.5" Fy="0.5" R="0.5">
                        <ChartGradientColorStops>
                            <ChartGradientColorStop Offset="0" Color="#F97316" Opacity="1" />
                            <ChartGradientColorStop Offset="100" Color="#4F46E5" Opacity="1" />
...
```
![Trendlines in Blazor Spline Chart with Radial Gradient](images/gradient/blazor-spline-chart-linear-trendlines-radial-gradient.webp)

### Technical Indicators

Apply a radial gradient to a technical indicator by adding [ChartRadialGradient](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartRadialGradient.html) inside the target `ChartIndicator`. The same `X1`/`Y1`/`X2`/`Y2` properties used for the linear gradient are not available here; instead, use `Cx`, `Cy`, `Fx`, `Fy`, and `R` to position the gradient.
...
<SfChart Title="Equity Price - Jan-Nov 2025">
    ...
    <ChartIndicators>
        <ChartIndicator Type="TechnicalIndicators.Ema" Field="FinancialDataFields.Close" SeriesName="Equity Price" XName="Date" Period="3" Width="2">
            @* Indicator Radial Gradient: applied to the EMA indicator line *@
            <ChartRadialGradient Cx="0.5" Cy="0.5" Fx="0.5" Fy="0.5" R="0.5">
                <ChartGradientColorStops>
                    <ChartGradientColorStop Offset="0" Color="#7C3AED" Opacity="1" />
                    <ChartGradientColorStop Offset="100" Color="#F59E0B" Opacity="1" />
...
```
![Exponential Moving Average in Blazor Candle Chart with Radial Gradient](images/gradient/blazor-candle-chart-exponential-moving-average-radial-gradient.webp)

...
The [Blazor Chart](https://www.syncfusion.com/blazor-components/blazor-charts) provides selection support for the series and its data points on mouse or touch action.

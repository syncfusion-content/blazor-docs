...
description: Learn here all about Stacked Area Series in the Syncfusion Blazor Chart component and its properties for customization.
platform: Blazor
control: Chart
documentation: ug
---

# Stacked Area Chart in Blazor Charts Component

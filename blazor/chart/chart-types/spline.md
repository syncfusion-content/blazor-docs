...
description: Learn here all about Spline Series in the Syncfusion Blazor Chart component and its properties for customization.
platform: Blazor
control: Chart
documentation: ug
---

# Spline Chart in Blazor Charts Component

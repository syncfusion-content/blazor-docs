...
description: Learn here all about Box and Whisker Series in the Syncfusion Blazor Chart component and its properties for customization.
platform: Blazor
control: Chart
documentation: ug
---
...
![Box and Whisker Charts with box plot mode](../images/othertypes/box-plot.png)
...
![Box and Whisker Charts with average value](../images/chart-types-images/box-mean.png)

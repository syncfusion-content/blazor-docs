...
<SfChart Title="Family Expense for Month">
    ...
    <ChartSeriesCollection>
        <ChartSeries XName="X" DataSource="@ExpenseReports" YName="Y" Type="ChartSeriesType.StackingLine100">
            <ChartEmptyPointSettings Mode="EmptyPointMode.Average" Fill="#8E44AD"></ChartEmptyPointSettings> 
...
@code {
    ...
    public List<ChartData> ExpenseReports = new List<ChartData>
    {
        new ChartData { X = "Food", Y = 90 },
        new ChartData { X = "Transport", Y = 80 },
        new ChartData { X = "Medical", Y = 50 },
        new ChartData { X = "Clothes", Y = 70 },
        new ChartData { X = "Personal Care", Y = 30 },
        new ChartData { X = "Books", Y = double.NaN },
        new ChartData { X = "Fitness", Y = double.NaN },
        new ChartData { X = "Electricity", Y = double.NaN },
        new ChartData { X = "Tax", Y = double.NaN },
        new ChartData { X = "Pet Care", Y = 40 },
        new ChartData { X = "Education", Y = 45 },
        new ChartData { X = "Entertainment", Y = 75 }
    };
}

```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hNhfXFWHBduLMUiP?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hNVTjPMxVcLWpcMo?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %}
...
@code {
    ...
    public List<ChartData> ExpenseReports = new List<ChartData>
    {
        ...
        new ChartData { X = "Clothes", Y = 70 },
        new ChartData { X = "Personal Care", Y = 30 },
        new ChartData { X = "Books", Y = 10 },
        new ChartData { X = "Fitness", Y = 100 },
        new ChartData { X = "Electricity", Y = 55 },
        new ChartData { X = "Tax", Y = 20 },
        new ChartData { X = "Pet Care", Y = 40 },
        new ChartData { X = "Education", Y = 45 },
        new ChartData { X = "Entertainment", Y = 75 }
    };
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VZhTXFCxrcdVRCxj?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VNrpjvsnrQPCIGoq?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %}

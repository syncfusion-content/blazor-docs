...
@code {
    ...
    public List<ChartData> ExpenseReports = new List<ChartData>
    {
         new ChartData { X = "Food" , Y = 90, Y1 = 40 , Y2=
	{
         new ChartData { X = "Food" , Y = 90, Y1 = 40 , Y2= 70, Y3= 120},
         new ChartData { X = "Transport", Y = 80, Y1 = 90, Y2= 110, Y3= 70 },
         new ChartData { X = "Medical",Y = 50, Y1 = 80, Y2= 120, Y3= 50 },
...
![Blazor Stacking Line Chart with Stack Labels](../images/chart-types-images/blazor-stacked-line-chart-stack-labels.png)
...
```
![Blazor Stacked Line Chart with Stack Label Customization](../images/chart-types-images/blazor-stacked-line-chart-stack-labels-customization.png)

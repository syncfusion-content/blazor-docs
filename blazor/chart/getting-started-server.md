...
description: Learn here all about Getting Started with Syncfusion Blazor Charts in Blazor Server Side App using CLI and more.
platform: Blazor
control: Chart
documentation: ug
---
...
# Blazor Charts Component in Server Side App using CLI

...
The `InsertSheetAsync()` method enables programmatic insertion of multiple sheets at the desired index.

The following code example illustrates how to insert a sheet programmatically.
...
The following code example illustrates how to delete a sheet programmatically.
...
The Spreadsheet component provides support for renaming worksheets. Existing worksheets can be dynamically renamed through the following method:

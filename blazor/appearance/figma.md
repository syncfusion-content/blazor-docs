---
layout: post
title: Figma UI kits for Blazor Components | Syncfusion®
...
- Developers can match controls to design requirements for alignment and accuracy.
...
Download customized style changes as tokens and CSS variables using the Design Tokens plugin. This plugin bridges the gap between design and development by converting Figma design variables into tokens for direct use in your applications to ensure a smooth transition from design to implementation.
...
- Navigate to the `Plugins and widgets` section in Figma and search for **Design Tokens**.

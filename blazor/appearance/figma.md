...
# Figma UI kits for Blazor Components
...
The Syncfusion® Figma UI kits are available in the [Figma community](https://www.figma.com/@syncfusion). Download the theme-specific kits from the following links:

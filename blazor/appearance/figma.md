...
- Developers can seamlessly match Syncfusion&reg; controls with your design requirements, ensuring alignment and accuracy.
...
Syncfusion&reg; Figma UI kits are available in the [Figma community](https://www.figma.com/@syncfusion). You can download the Syncfusion&reg; theme-specific Figma UI kits from the following links:
...
3. For the desktop application, click the **Import** button in the top-right corner of the page. Select the downloaded Syncfusion&reg; fig file you want to import and click the **Open** button.
...
- Share your experience with Syncfusion&reg; regarding the upgraded UI kits, including any issues encountered or suggestions for improvement.

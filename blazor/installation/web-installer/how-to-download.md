...
description: Learn here about how to download Syncfusion Blazor web installer from our Syncfusion website with license.
platform: Blazor
component: Common
documentation: ug
---
...
4. Before the trial license expires, you can download the Blazor installer at any time from your registered account’s [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page as shown in following screenshot.

5. Click the Download (element 1 in the screenshot below) button to download the Blazor web installer.

   ![Trial Download Online Installer](images/start-trial-download-installer-1.png)

...
description: Checkout and learn about getting started with Blazor Timeline component in Blazor Server App and Blazor WebAssembly App.
platform: Blazor
control: Timeline
documentation: ug
---
...
Add the Syncfusion&reg; Blazor Timeline component in the **~/Pages/Index.razor** file.

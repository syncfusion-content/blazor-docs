...
## Install Syncfusion Blazor Calendar and Theme NuGet in the App
...
Now, register the Syncfusion Blazor Service in the **~/Program.cs** file of your Blazor ASP.NET Core Hosted WebAssembly app. 

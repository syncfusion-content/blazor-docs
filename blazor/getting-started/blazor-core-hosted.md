...
description: Check out the documentation for getting started with Blazor ASP.NET Core Hosted App and Syncfusion Blazor Components in Visual Studio.
platform: Blazor
component: Common
documentation: ug
---
...
This article provides a step-by-step instructions for building Blazor ASP.NET Core Hosted application with `Blazor Calendar` components using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
You can create Blazor ASP.NET Core Hosted app using Visual Studio in one of the following ways,
...
* Add the Syncfusion bootstrap5 theme in the `<head>` element of the **~/wwwroot/index.html** page in **`Client`[BlazorWasmHosted.Client]** project.

...
This section explains how to create and run desktop applications using Blazor and Electron Framework with Syncfusion&reg; Blazor components.
...
N> [View the complete Blazor Server electron application with Syncfusion&reg; controls on GitHub](https://github.com/SyncfusionExamples/blazor-electron-app)

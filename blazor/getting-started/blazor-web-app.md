...
# Getting Started with Syncfusion Blazor Component in Blazor Web App

This article provides a step-by-step instructions for building `Blazor Web App` with  `Syncfusion Blazor Component` using [Visual Studio](https://visualstudio.microsoft.com/vs/).

...
## Using Syncfusion&reg; Blazor Template
...
Add the Syncfusion&reg; Blazor Accordion component in the **~/Components/Pages/*.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/*.razor` component, as follows:

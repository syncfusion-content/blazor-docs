...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. The Blazor Calendar component is rendered in the default browser.

![Blazor Web App rendering the Blazor Calendar component](images/core-hosted/browser-output.png)

...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VXLRZdCCpxDqpuWZ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Breadcrumb Component](./images/blazor-Breadcrumb-item-template.png)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hXBntHMMzHDnPVbH?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Breadcrumb Component](./images/blazor-breadcrumb-separator-temp.png)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VXhHXRWipdWiDWGo?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Breadcrumb Component](./images/breadcrumb-specific-item-template.png)" %}
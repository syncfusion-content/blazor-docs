...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VXLRZdCCpxDqpuWZ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" .webp "[Blazor Breadcrumb Component](./images/blazor-Breadcrumb-item-template.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hXBntHMMzHDnPVbH?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" .webp "[Blazor Breadcrumb Component](./images/blazor-breadcrumb-separator-temp.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VXhHXRWipdWiDWGo?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" .webp "[Blazor Breadcrumb Component](./images/breadcrumb-specific-item-template.webp)" %}
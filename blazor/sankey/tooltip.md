...
description: Enable Blazor Sankey Diagram tooltips with SankeyTooltipSettings to show node and link details, with custom templates, fill, opacity, and fade animation.
platform: Blazor
control: Sankey
documentation: ug
---

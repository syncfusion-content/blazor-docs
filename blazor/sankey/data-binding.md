...
description: Bind Blazor Sankey Diagram data with SankeyDataNode and SankeyDataLink collections, including node IDs, source/target links, and dynamic REST API loading.
platform: Blazor
control: Sankey
documentation: ug
---

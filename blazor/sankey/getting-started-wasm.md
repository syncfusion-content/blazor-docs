...
description: Add the Blazor Sankey Diagram to a Blazor WebAssembly App by installing Syncfusion.Blazor.Sankey, importing namespaces, and registering the client builder.
platform: Blazor
control: Sankey
documentation: ug
---

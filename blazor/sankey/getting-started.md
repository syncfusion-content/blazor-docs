---
layout: post
title: Getting Started with Blazor Sankey Diagram Component
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Blazor Sankey Diagram in your default web browser.

...
description: Add the Blazor Sankey Diagram to a Blazor Web App with Auto interactivity by installing the Sankey NuGet package and configuring the client project.
platform: Blazor
control: Sankey
documentation: ug
---

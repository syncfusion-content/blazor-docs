---
layout: post
title: Getting Started with Blazor NumericTextBox in Server App | Syncfusion®
description: Learn how to get started with the Blazor NumericTextBox in a Blazor Server App with installation and configuration steps.
platform: Blazor
...
Add the Blazor NumericTextBox component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.

...
description: Learn how to get started with the Blazor NumericTextBox component in a Blazor WebAssembly application with installation and configuration steps.
platform: Blazor
...
Add the Blazor NumericTextBox component in the **~/Pages/Index.razor** file.

...
Install the [CLDR-Data](https://cldr.unicode.org/development/guidance-on-direct-modifications-to-cldr-data) package using the following command (it installs the CLDR JSON data).

```
npm install cldr-data --save
```

To know more about CLDR-Data, refer to [CLDR-Data](https://cldr.unicode.org/development/guidance-on-direct-modifications-to-cldr-data).

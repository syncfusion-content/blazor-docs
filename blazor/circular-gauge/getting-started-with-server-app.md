---
layout: post
title: Getting Started with Syncfusion Blazor CircularGauge in Server App
...
# Getting Started with Blazor CircularGauge Component in Blazor Server App
...
## Install Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor CircularGauge NuGet in the App
...
* Run the following command to install a [Syncfusion.Blazor.CircularGauge](https://www.nuget.org/packages/Syncfusion.Blazor.CircularGauge/) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/) NuGet packages and ensure all dependencies are installed.
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor CircularGauge component

Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor CircularGauge component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `Home.razor` page.

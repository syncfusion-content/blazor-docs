---
layout: post
title: Animation in Blazor Circular Gauge | Syncfusion®
description: Animate Blazor Circular Gauge elements sequentially using the AnimationDuration property to render axis, ticks, labels, ranges, pointers, and annotations.
platform: Blazor
control: Circular Gauge
documentation: ug
---

# Animation in Blazor Circular Gauge

---
layout: post
title: Getting Started with Blazor Range Slider in Blazor Web App | Syncfusion®
description: Check out the documentation for getting started with Blazor Range Slider Components in Blazor Web App with examples and much more details.
platform: Blazor
...
Add the Blazor Range Slider component in the **~/Components/Pages/*.razor** file. If the interactivity location is set to `Per page/component` in the Web App, define a render mode at the top of the `~/Pages/*.razor` file. (For example, `InteractiveServer`, `InteractiveWebAssembly` or `InteractiveAuto`).

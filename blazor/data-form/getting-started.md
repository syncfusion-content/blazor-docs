...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Data Form](https://www.syncfusion.com/blazor-components/blazor-data-form) component inside the razor file.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/hNhfXCLaBIvJBwaZ?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" backgroundimage "[Blazor Data Form getting started example](images/blazor-dataform.webp)" %}

...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Button Group component

* Open a Razor file located in the **~/Components/Pages** (for example, **Home.razor**) and add the Blazor Button Group component inside the razor file.

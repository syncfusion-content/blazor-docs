...
Add the Syncfusion Blazor ButtonGroup component in the **~/Pages/Index.razor** file.
...
* [Getting Started with Web App for Blazor Button Group Component in Visual Studio](https://blazor.syncfusion.com/documentation/button-group/getting-started-with-web-app)

...
N> Only in WebAssembly applications can you set the ReferencePath. You can't set the ReferencePath in the Server application because of service dependencies that are not available. Only WebAssembly applications support service dependencies.

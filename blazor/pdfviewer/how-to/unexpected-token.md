...
N> Only in WebAssembly applications can we set the ReferencePath. We can't set the ReferencePath in the Server application because of service dependencies that are not available. Only WebAssembly applications support service dependencies.

...
![putty-session-login](GettingStarted_images/putty-image.png)
2. Navigate to root directory in the opened terminal and type ls for listing the directories
![linux-directories](GettingStarted_images/linux-terminal.png)
...
![install-dotnet-frameworks](GettingStarted_images/dotnet-info.png)
...
![beanstalk-publish](GettingStarted_images/beanstalk-publish.png)
2. Select the Deployment Target as Create a new application environment and click Next button.
![deployment-target](GettingStarted_images/beanstalk-instance.png)
...
![beanstalk-environment-name](GettingStarted_images/beanstalk-environment.png)
4. Select the instance type in t3a.micro from the dropdown list and click next.
![beanstalk-instance-type](GettingStarted_images/beanstalk-aws-options.png)
5. Click the Next button to proceed further.
![beanstalk-roles](GettingStarted_images/beanstalk-permissions.png)
6. Click the Next button
![beanstalk-review](GettingStarted_images/beanstalk-review.png)
7. Click the Deploy button to deploy the sample on AWS Elastic Beanstalk.
![beanstalk-deploy](GettingStarted_images/beanstalk-deploy.png)
8. After changing the status from Updating to Environment is healthy, click the URL.
![beanstalk-success-message](GettingStarted_images/beanstalk-success.png)
9. After opening the provided URL the provided PDF document will be displayed in PDF Viewer.
![beanstalk-output](GettingStarted_images/beanstalk-output.png)

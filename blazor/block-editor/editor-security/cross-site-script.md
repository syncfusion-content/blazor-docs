...
description: Learn about Cross-Site Scripting (XSS) prevention and HTML sanitization in the Syncfusion Blazor Block Editor component for Blazor Server and WebAssembly applications.
platform: Blazor
control: BlockEditor
documentation: ug
---

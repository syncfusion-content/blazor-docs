...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Carousel](https://www.syncfusion.com/blazor-components/blazor-carousel) component inside the razor file.

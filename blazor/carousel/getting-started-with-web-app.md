---
layout: post
title: Getting Started with Blazor Carousel in Blazor Web App | Syncfusion®
description: Learn how to get started with the Syncfusion Blazor Carousel control. Explore setup, features, examples, and customization options.
platform: Blazor
component: Carousel
documentation: ug
---

# Getting Started with Blazor Carousel in Blazor Web App

This section briefly explains how to include the [Blazor Carousel](https://www.syncfusion.com/blazor-components/blazor-carousel) component in your Blazor Web App using [Visual Studio](https://visualstudio.microsoft.com/vs/), [Visual Studio Code](https://code.visualstudio.com/), and the [.NET CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/).
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Blazor Carousel functionality.
...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Carousel](https://www.syncfusion.com/blazor-components/blazor-carousel) component inside the `.Client` project Razor file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [Blazor Carousel](https://www.syncfusion.com/blazor-components/blazor-carousel) component will render in your default web browser.

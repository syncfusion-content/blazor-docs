---
layout: post
title: Getting Started Blazor DateTime Picker Blazor Server App | Syncfusion
description: Checkout and learn about the documentation for getting started with Blazor DateTime Picker Component in Blazor Server App.
platform: Blazor
component: DateTime Picker
documentation: ug
---

# Getting Started with Blazor DateTime Picker Component in Blazor Server App
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BZLzDsBOKWcNOSex?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" backgroundimage "[Blazor DateTime Picker Component](./images/blazor-datetimepicker-component.webp)" %}

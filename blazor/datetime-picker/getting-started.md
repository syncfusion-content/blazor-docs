...
description: Learn how to get started with the Syncfusion Blazor DateTimePicker in a Blazor WebAssembly app, including NuGet installation, service registration, and adding styles and scripts.
platform: Blazor

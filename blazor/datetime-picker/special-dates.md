---
layout: post
title: Special Dates in Blazor DateTime Picker | Syncfusion®
description: Customize special dates in the Blazor DateTime Picker using the OnRenderDayCell event to highlight, style, or disable specific days.
platform: Blazor

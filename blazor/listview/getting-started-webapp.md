...
# Getting Started with Blazor ListView Web App

This article provides a step-by-step instructions for building `Blazor Web App` with [Blazor ListView](https://www.syncfusion.com/blazor-components/blazor-listview) component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
Add the Syncfusion Blazor ListView component in the **~/Components/Pages/*.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/*.razor` component, as follows:

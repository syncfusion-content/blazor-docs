...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/rtrxXGWZfmCyCuzZ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Disable State in Blazor ColorPicker](./../images/blazor-colorpicker-disable-state.webp)" %}

...
description: Checkout and learn here all the features about Hide control buttons in Blazor Color Picker component and much more.
platform: Blazor
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/VZBxNQsXJcLDdCLr?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Hide Control Buttons in Blazor ColorPicker](./../images/blazor-colorpicker-hide-control.webp)" %}

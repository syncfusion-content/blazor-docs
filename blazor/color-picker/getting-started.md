...
To get started quickly with ColorPicker Component using Blazor, you can check out this video or [GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/ColorPicker) sample:
...
Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ColorPicker component in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ColorPicker component in your default web browser.

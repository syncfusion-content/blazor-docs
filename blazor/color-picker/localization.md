...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hDrdNQsDpQpUHgUE?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Localization in Blazor ColorPicker](./images/blazor-colorpicker-localization.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/LNrxjGitzcyDivPg?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Right to Left in Blazor ColorPicker](./images/blazor-colorpicker-right-to-left.webp)" %}

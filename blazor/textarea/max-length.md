...
{% previewsample "https://blazorplayground.syncfusion.com/embed/VZrxNwtiziicHtfQ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor TextArea with MaxLength](./images/blazor-textarea-maxlength.webp)" %}
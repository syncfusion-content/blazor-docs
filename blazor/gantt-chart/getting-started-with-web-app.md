...
## Install Syncfusion&reg; Blazor Gantt and Themes NuGet in the Blazor Web App
...
## Add Syncfusion&reg; Blazor Gantt Chart component

Add the Syncfusion&reg; Blazor Gantt Chart component in `.razor` file inside the `Pages` folder. If an interactivity location as `Per page/component` in the web app, define a render mode at top of the component, as follows:

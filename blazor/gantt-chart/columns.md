...
@code{
    ...
    public List<Object> ToolbarItems = new List<Object>() {new Syncfusion.Blazor.Navigations.ItemModel() { Text = "Column Chooser", TooltipText = "Column Chooser", Id = "columnchooser"}};

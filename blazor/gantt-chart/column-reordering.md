...
The [Blazor Gantt Chart](https://www.syncfusion.com/gantt-sdk/blazor-gantt-chart) component supports column reordering by dragging a column header to a new position. 

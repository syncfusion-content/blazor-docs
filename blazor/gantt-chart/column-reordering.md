...
# Column reorder in Blazor Gantt component

The Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Gantt component supports column reordering by dragging a column header to a new position. 
...
You can reorder columns programmatically in the Gantt component using the [ReorderColumnsAsync](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Gantt.SfGantt-1.html#Syncfusion_Blazor_Gantt_SfGantt_1_ReorderColumnsAsync_System_Collections_Generic_List_System_String__System_String_) method.  This method reorders one or more columns by specifying the source column(s) and the target column using their field names:  

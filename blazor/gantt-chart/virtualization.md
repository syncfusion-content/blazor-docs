...
<SfGantt DataSource="@TaskCollection" EnableVirtualization="true" TValue="GanttDataSource" Width="700px" Height="450px">
    <GanttTaskFields Id="TaskId" Name="TaskName" StartDate="StartDate" Duration="Duration" Progress="Progress" Dependency="Predecessor" ParentID="ParentID">
    </GanttTaskFields>
</SfGantt>
@code {
    public List<GanttDataSource> TaskCollection { get; set; }
    protected override void OnInitialized()
    {
        this.TaskCollection = VirtualData();
    }
        ...
        public static List<TaskData> GetTreeVirtualData()
        {
            ...
            for (var i = 1; i <= 100; i++)
            {
                TaskData Parent = new TaskData()
                {
                    ...
                    ProjectDuration = "10",
                    ProjectProgress = ((i/2) + x) > 100 ? 100 : (i/2) + x,
                    ParentId = null,
                    Predecessor = null,
                };
...
<SfGantt @ref="Gantt" Width="700px" Height="450px" ID="Gantt" DataSource="@TaskCollection"  Toolbar="@(new  List<string>() { "ZoomIn", "ZoomOut", "ZoomToFit"})" GridLines="Syncfusion.Blazor.Gantt.GridLine.Both" ProjectStartDate="@ProjectStart" ProjectEndDate="@ProjectEnd"

    ...
    public static List<TaskData> GetTaskCollection()
    {
        List<TaskData> Tasks = new List<TaskData>()
        {
            ...
            new TaskData() {
                ...
                StartDate = new DateTime(2022, 04, 10),
                EndDate = new DateTime(2022, 04, 21),
            },
            new TaskData() {
                TaskId = 6,
    ...
    public static List<TaskData> GetTaskCollection()
    {
        List<TaskData> Tasks = new List<TaskData>()
        {
            ...
            new TaskData() {
                ...
                EndDate = new DateTime(2022, 09, 21),
            },
            new TaskData() {
                TaskId = 6,
                TaskName = "Develop floor plan for estimation",
    ...
    public static List<TaskData> GetTaskCollection()
    {
        List<TaskData> Tasks = new List<TaskData>()
        {
            ...
            new TaskData() {
                TaskId = 2,
                TaskName = "Identify site location",
                StartDate = new DateTime(2022, 04, 02, 09, 0, 0),
                Duration = "5",
                Progress = 70,
                ParentId = 1
            },
            ...
            new TaskData() {
                TaskId = 6,
                TaskName = "Develop floor plan for estimation",
                StartDate = new DateTime(2022, 04, 02, 11, 0, 0),
                Duration = "5",
                Progress = 70,
                ParentId = 5
            },
    ...
    public static List<TaskData> GetTaskCollection()
    {
        List<TaskData> Tasks = new List<TaskData>()
        {
            ...
            new TaskData() {
                TaskId = 2,
                TaskName = "Identify site location",
                StartDate = new DateTime(2022, 04, 02, 8, 4, 0),
                Duration = "5",
                Progress = 70,
                ParentId = 1
            },
            ...
            new TaskData() {
                TaskId = 6,
                TaskName = "Develop floor plan for estimation",
                StartDate = new DateTime(2022, 04, 02, 8, 10, 0),
                Duration = "5",
                Progress = 70,
                ParentId = 5
            },
    ...
    public static List<TaskData> GetTaskCollection()
    {
        List<TaskData> Tasks = new List<TaskData>()
        {
            new TaskData() {
                ...
                TaskName = "Project initiation",
                StartDate = new DateTime(2022, 04, 02),
                EndDate = new DateTime(2022, 08, 21),
            },
            new TaskData() {
                TaskId = 2,
                TaskName = "Identify site location",
...
@code{
    ...
    List <TaskData> Tasks = new List <TaskData> () {
        ...
        new TaskData() {
            TaskId = 6,
            TaskName = "Develop floor plan for estimation",
            StartDate = new DateTime(2022, 06, 04),
            Duration = "33",
            Progress = 30,
            ParentId = 5
        },
        ...
        new TaskData() {
            TaskId = 8,
            TaskName = "Estimation approval",
            StartDate = new DateTime(2022, 08, 04),
            Duration = "20",
            Progress = 30,
            ParentId = 5
        }

...
The column menu in the [Blazor Gantt](https://www.syncfusion.com/gantt-sdk/blazor-gantt-chart) component offers built-in actions including sorting, filtering, column chooser, and autofit. It appears when the column header icon is clicked.

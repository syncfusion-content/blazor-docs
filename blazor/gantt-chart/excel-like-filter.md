...
# Excel like filter in Blazor Gantt compoenent
...
You can customize the text shown in the filter dialog of the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Gantt compoenent by using the `FilterItemTemplate` property. This feature allows you to present meaningful labels based on the values of a specific column.

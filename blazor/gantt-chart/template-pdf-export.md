...
The [Blazor Gantt Chart](https://www.syncfusion.com/blazor-components/blazor-gantt-chart) export functionality allows you to export both column and header templates to a PDF document. These templates can include various customizations such as images, formatted text, and custom cell styles within the header and columns. 

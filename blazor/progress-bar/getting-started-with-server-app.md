---
layout: post
title: Getting Started with Blazor ProgressBar in Blazor Server App | Syncfusion®
description: Learn how to get started with Blazor ProgressBar in Blazor Server App with examples and much more details.
platform: Blazor
control: ProgressBar
documentation: ug
---
...
Add the Blazor ProgressBar component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.

---
layout: post
title: Getting started with Syncfusion ProgressBar in Blazor Server App
description: Check out the documentation for getting started with Syncfusion Blazor ProgressBar Components in Blazor Server App.
platform: Blazor
control: ProgressBar
documentation: ug
---

# Getting Started with Blazor ProgressBar Component in Blazor Server App
...
To add the **Blazor ProgressBar** component in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), then search and install [Syncfusion.Blazor.ProgressBar](https://www.nuget.org/packages/Syncfusion.Blazor.ProgressBar/) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/). Alternatively, run the following commands in the Package Manager Console to achieve the same.
...
* Run the following command to install a [Syncfusion.Blazor.ProgressBar](https://www.nuget.org/packages/Syncfusion.Blazor.ProgressBar/) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/) NuGet packages and ensure all dependencies are installed.

{% tabs %}

{% highlight c# tabtitle="Package Manager" %}

dotnet add package Syncfusion.Blazor.ProgressBar -v {{ site.releaseversion }}
...
To add the **Blazor ProgressBar** component to the application, run the following commands in a command prompt (Windows), command shell (Linux), or terminal (macOS) to install the [Syncfusion.Blazor.ProgressBar](https://www.nuget.org/packages/Syncfusion.Blazor.ProgressBar/) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/) NuGet packages. See [Install and manage packages using the dotnet CLI](https://learn.microsoft.com/en-us/nuget/consume-packages/install-use-packages-dotnet-cli) for more details.

{% tabs %}
{% highlight c# tabtitle=".NET CLI" %}

dotnet add package Syncfusion.Blazor.ProgressBar -Version {{ site.releaseversion }}
...
Open the **~/_Imports.razor** file and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.ProgressBar` namespaces.
...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ProgressBar component

Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ProgressBar component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `Home.razor` page.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ProgressBar component in the default web browser.

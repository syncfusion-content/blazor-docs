...
To get started quickly with the Blazor ProgressBar component, refer to this [GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/ProgressBar) sample.
...
* Run the following command to install the [Syncfusion.Blazor.ProgressBar](https://www.nuget.org/packages/Syncfusion.Blazor.ProgressBar) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/) NuGet packages and ensure all dependencies are installed.
...
Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor ProgressBar component in the **~/Pages/Index.razor** file.

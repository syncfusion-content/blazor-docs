...
This section briefly explains about how to include [Blazor ProgressBar](https://www.syncfusion.com/blazor-components/blazor-progressbar) component in your Blazor Server App and Blazor WebAssembly App using Visual Studio. To get start quickly with Progress Bar Component using Blazor, you can check on this video:
...
* Open **~/_Imports.razor** file or any other page under the `~/Pages` folder where the component is to be added and import the **Syncfusion.Blazor.ProgressBar** namespace.
...
* Now, add the Syncfusion ProgressBar component in razor file. Here, the ProgressBar component is added in the **~/Pages/Index.razor** file under the **~/Pages** folder.

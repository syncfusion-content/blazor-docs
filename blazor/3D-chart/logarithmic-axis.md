---
layout: post
title: Logarithmic Axis in Blazor 3D Charts | Syncfusion®
description: Visualize data across many orders of magnitude in Syncfusion Blazor 3D Charts by setting the axis ValueType to Logarithmic on the Y axis.
platform: Blazor
control: 3D Charts
documentation: ug
---

# Logarithmic Axis in Blazor 3D Charts
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/rXhnXnWtfLBfHkTa?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor 3D Chart with Logarithmic Axis](images/logarithmic-axis/blazor-chart-logarithmic-axis.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/BNrnDniZTVBYXqdB?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Changing Blazor Column 3D Chart Logarithmic Axis based on Range](images/logarithmic-axis/blazor-column-chart-axis-based-on-range.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/LXVxZxstfhUoieeR?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Column 3D Chart Logarithmic Axis with Base](images/logarithmic-axis/blazor-column-chart-logarithmic-axis-with-base.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hZLHXdstTVpipeOU?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Changing Blazor Column 3D Chart Logarithmic Axis based on Interval](images/logarithmic-axis/blazor-column-chart-axis-based-on-range-interval.webp)" %}

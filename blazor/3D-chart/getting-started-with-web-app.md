...
## Install Syncfusion&reg; Blazor 3D Chart NuGet in the Blazor Web App
...
If you select an **Interactive render mode** as `WebAssembly` or `Auto (Server and WebAssembly)`, you need to register the Syncfusion&reg; Blazor service in both **~/Program.cs** files of your Blazor Web App.
...
## Add Syncfusion&reg; Blazor 3D Chart component

Add the Syncfusion&reg; Blazor 3D Chart component in `.razor` file inside the `Pages` folder. If an interactivity location as `Per page/component` in the web app, define a render mode at top of the component, as follows:
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Syncfusion&reg; Blazor 3D Chart component in your default web browser.

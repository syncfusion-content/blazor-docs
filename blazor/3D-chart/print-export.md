...
description: Checkout and learn here all features about Print and Export in Blazor 3D Chart component and much more.
platform: Blazor
control: 3D Chart
documentation: ug
---
...
![Printing in Blazor 3D Chart](images/getting-started/blazor-chart-printing.webp)
...
![Exporting in Blazor 3D Chart](images/getting-started/blazor-chart-exporting.webp)

...
1. Install [Syncfusion.Blazor.Navigations](https://blazor.syncfusion.com/documentation/nuget-packages/#syncfusionblazornavigations) NuGet package to the application using the `NuGet Package Manager`.

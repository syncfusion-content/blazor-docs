...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BtLHXHiislmbOHoF?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Adding or Removing items in Blazor Accordion](../images/blazor-accordion-add-remove-item.gif)" %}

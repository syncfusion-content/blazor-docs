...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rDLHjxMiCPEfbiEL?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Enabling or Disabling Item in Blazor Accordion](../images/blazor-accordion-enable-disable-item.gif)" %}

---
layout: post
title: Getting Started with Syncfusion Blazor Accordion Component in WebApp
...
# Getting Started with Blazor Accordion Component in Web App

This article provides a step-by-step instructions for building `Blazor Web App` with [Blazor Accordion](https://www.syncfusion.com/blazor-components/blazor-accordion) component using [Visual Studio](https://visualstudio.microsoft.com/vs/).

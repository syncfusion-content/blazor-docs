...
{% previewsample "https://blazorplayground.syncfusion.com/embed/LZhUCBMgKgFlilcn?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" backgroundimage "[Blazor Accordion with header and content Template](images/blazor-accordion-header-template.png)" %}

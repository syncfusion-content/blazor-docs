---
layout: post
title: Getting started with Blazor Chat UI in Blazor Server App |Syncfusion
description: Check out and learn the documentation for getting started with Blazor Chat UI Component in Blazor Server App.
platform: Blazor
control: Chat UI
documentation: ug
---
...
This section briefly explains how to include the [Blazor Chat UI](https://www.syncfusion.com/blazor-components/blazor-chat-ui) component in a Blazor Server App using [Visual Studio](https://visualstudio.microsoft.com/vs/), [Visual Studio Code](https://code.visualstudio.com/), and the [.NET CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/).
...
Open a Razor file located in the **~/Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Chat UI](https://www.syncfusion.com/blazor-components/blazor-chat-ui) component inside the razor file.

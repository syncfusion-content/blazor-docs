---
layout: post
title: Getting started with Chat UI in Blazor Server App | Syncfusion®
description: Checkout and learn the documentation for getting started with Blazor Chat UI Components in Blazor Server App.
platform: Blazor
control: Chat UI
documentation: ug
---

---
layout: post
title: Getting started with Syncfusion Blazor RichTextEditor Web App
description: Check out the documentation for getting started with Syncfusion Blazor RichTextEditor Components in Blazor Web App.
platform: Blazor
control: RichTextEditor
documentation: ug
---

# Getting Started with Blazor RichTextEditor Web App

This article provides a step-by-step instructions for building `Blazor Web App` with [Blazor RichTextEditor](https://www.syncfusion.com/blazor-components/blazor-wysiwyg-rich-text-editor) component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
## Add Syncfusion Blazor RichTextEditor component

Add the Syncfusion Blazor RichTextEditor component in the **~/Components/Pages/*.razor** file. If an interactivity location as `Per page/component` in the web app, define a render mode at the top of the `~Pages/*.razor` component, as follows:

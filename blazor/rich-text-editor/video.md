...
> By default, it doesn't support the `UseDefaultCredentials` property, so we need to manually append the default credentials with the upload request.

...
## Install Syncfusion&reg; Blazor RichTextEditor and Themes NuGet in the App
...
Add the Syncfusion&reg; Blazor RichTextEditor component in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This will render the Syncfusion&reg; Blazor RichTextEditor component in your default web browser.

...
* [Getting Started with Web App for Blazor Floating Action Component in Visual Studio](https://blazor.syncfusion.com/documentation/floating-action-button/getting-started-with-web-app)
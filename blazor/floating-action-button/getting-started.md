...
To add Blazor Floating Action Button component in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), search for [Syncfusion.Blazor.Buttons](https://www.nuget.org/packages/Syncfusion.Blazor.Buttons) and then install it.
...
* Now, add the Syncfusion Blazor Floating Action Button component in razor file. Here, the Floating Action Button component is added in the **~/Pages/Index.razor** file under the **~/Pages** folder.

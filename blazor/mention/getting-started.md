...
description: Checkout and learn about getting started with Blazor Mention component in Blazor WebAssembly Application and much more details.
platform: Blazor
control: Mention
documentation: ug
---
...
Add the Blazor Mention component in the **~/Pages/Index.razor** file.

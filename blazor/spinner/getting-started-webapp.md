...
description: Learn how to get started with the Syncfusion Blazor Spinner in a Blazor Web App using setup steps and code examples.
platform: Blazor
component: Spinner
documentation: ug
---
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Spinner functionality.

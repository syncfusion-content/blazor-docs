...
Add the Syncfusion&reg; Blazor Spinner component with Syncfusion&reg; Blazor [Button](https://blazor.syncfusion.com/documentation/button/getting-started) component  in the **~/Pages/Index.razor** file.

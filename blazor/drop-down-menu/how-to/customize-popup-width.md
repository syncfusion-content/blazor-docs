---
layout: post
title: How to customize popup width in Blazor Dropdown Menu | Syncfusion®
description: Customize the Blazor Dropdown Menu popup width using the PopupWidth property or CSS to ensure items fit comfortably in the menu.
platform: Blazor
control: Dropdown Menu
documentation: ug
---

# How to customize popup width in Blazor Dropdown Menu

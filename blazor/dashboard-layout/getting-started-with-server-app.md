---
layout: post
title: Getting Started with Blazor Dashboard in Blazor Server App | Syncfusion
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rNLSDIVjTEDbFVUJ?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" backgroundimage "[Blazor Dashboard displays Chart Component Content](images/blazor-dashboard-layout-with-chart-component.png)" %}

...
description: Checkout and learn about display modes in Blazor SpeedDial component and much more.
platform: Blazor
control: SpeedDial
documentation: ug
---
...
![Blazor SpeedDial with direction](./images/Blazor-SpeedDial-LinearMode.png)

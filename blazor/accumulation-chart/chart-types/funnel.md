...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/BNrKtcVRLAZWOatS?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/BjrANGrRhUMDviSo?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/BjLKZQrnVqVIjAHM?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/BDrKNcrRBKfHbHhN?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/rZhAjwLRhqdSUZHh?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->
...
<!-- {% previewsample "https://blazorplayground.syncfusion.com/embed/VXLAZwLnVgQHgcpV?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %} -->

N> Refer to the [Blazor Charts](https://www.syncfusion.com/blazor-components/blazor-charts) feature tour page for its groundbreaking feature representations and also explore the [Blazor Accumulation Chart Example](https://blazor.syncfusion.com/demos/chart/funnel?theme=bootstrap5
 ) to know various features of accumulation charts and how it is used to represent numeric proportional data.

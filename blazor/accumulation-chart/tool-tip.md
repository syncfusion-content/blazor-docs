...
N> Refer to the [Blazor Charts](https://blazor.syncfusion.com/demos/chart/pie?theme=bootstrap5) feature tour page for its groundbreaking feature representations and also explore the [Blazor Accumulation Chart Example](https://www.syncfusion.com/blazor-components/blazor-charts) to know about the various features of accumulation charts and how it is used to represent numeric proportional data.

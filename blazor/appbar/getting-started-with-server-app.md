...
# Getting Started with Blazor AppBar in Blazor Server App
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable AppBar functionality.
...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor AppBar](https://www.syncfusion.com/blazor-components/blazor-appbar) component inside the razor file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [Blazor AppBar](https://www.syncfusion.com/blazor-components/blazor-appbar) component will render in your default web browser.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rXLHXxMshoHHefSV?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor AppBar Component](images/getting_started.webp)" %}

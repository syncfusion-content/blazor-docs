...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rNVHNxWMBQCveXKA?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor AppBar with Spacer.](./images/blazor-appbar-spacer.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/BXLHZHsirwVWPPec?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor AppBar with Separator.](./images/blazor-appbar-separator.webp)" %}

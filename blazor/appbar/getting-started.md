...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor AppBar](https://www.syncfusion.com/blazor-components/blazor-appbar) component inside the razor file.

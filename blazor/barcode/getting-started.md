...
* [Getting Started with Web App for Blazor Barcode Component in Visual Studio](https://blazor.syncfusion.com/documentation/barcode/getting-started-with-web-app)

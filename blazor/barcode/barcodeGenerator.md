...
Code 11 is used primarily for labeling the telecommunication equipments. The character set includes the digits 0 to 9, a dash (-), and a start/stop code.
...
* Code Set A (or Chars Set A) includes all of the standard upper case U.S. alphanumeric keyboard characters and punctuation characters along with the control characters (characters with ASCII values from 0 to 95 inclusive), and seven special characters.

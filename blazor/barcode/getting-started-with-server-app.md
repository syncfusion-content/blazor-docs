...
Add the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Barcode component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at top of the `~Pages/Home.razor` file.

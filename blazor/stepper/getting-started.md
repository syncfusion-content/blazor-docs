...
description: Checkout and learn about getting started with Blazor Stepper component in Blazor Server App and Blazor WebAssembly App.
platform: Blazor
control: Stepper
documentation: ug
---
...
Add the Syncfusion&reg; Blazor Stepper component in the **~/Pages/Index.razor** file.

...
RTL provides an option to switch the text direction and layout of the Blazor Stepper component from right to left. Refer to [Blazor RTL](https://blazor.syncfusion.com/documentation/common/right-to-left) topic to provide RTL support for the Blazor components.

...
PM> NuGet\Install-Package Syncfusion.Blazor.ImageEditor -Version {{ site.releaseversion }}
...
* For **.NET 7** app, add the Syncfusion bootstrap5 theme in the `<head>` of the **~/Pages/_Host.cshtml** page.

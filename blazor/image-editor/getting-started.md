---
layout: post
title: Getting Started with Blazor Image Editor in WASM App | Syncfusion
description: Learn how to add and configure the Blazor Image Editor component in a Blazor WebAssembly App using Visual Studio or Visual Studio Code.
platform: Blazor
control: Image Editor
documentation: ug
---

# Getting Started with Blazor Image Editor in Blazor WASM App
...
Install the [Syncfusion.Blazor.ImageEditor](https://www.nuget.org/packages/Syncfusion.Blazor.ImageEditor/) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/) NuGet packages. All Syncfusion Blazor packages are available on [nuget.org](https://www.nuget.org/packages?q=syncfusion.blazor). See the [NuGet packages](https://blazor.syncfusion.com/documentation/nuget-packages) topic for details.
...
2. Search the required NuGet packages (`Syncfusion.Blazor.ImageEditor` and `Syncfusion.Blazor.Themes`) and install them.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **~wwwroot/index.html** file to enable Image Editor functionality.
...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Image Editor](https://www.syncfusion.com/blazor-components/blazor-image-editor) component inside the razor file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [Blazor Image Editor](https://www.syncfusion.com/blazor-components/blazor-image-editor) component will render in your default web browser.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/LNhRtQjKVmjhaVXY?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Image Editor Component](./images/blazor-image-editor-component.webp)" %}

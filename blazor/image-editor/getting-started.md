...
## Install Syncfusion&reg; Blazor ImageEditor and Themes NuGet in the App
...
Add the Syncfusion&reg; Blazor Image Editor component in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the app. This will render the Syncfusion&reg; Blazor Image Editor component in your default web browser.

---
layout: post
title: Getting Started with Blazor Image Editor in Server App | Syncfusion
description: Learn how to add and configure the Blazor Image Editor component in a Blazor Server App using Visual Studio or Visual Studio Code.
platform: Blazor
component: Image Editor
documentation: ug
---

# Getting Started with Blazor Image Editor in Blazor Server App
...
After the packages are installed, open the **~/Components/_Imports.razor** file and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.ImageEditor` namespaces.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Image Editor functionality.
...
Open a Razor file located in the **~Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Image Editor](https://www.syncfusion.com/blazor-components/blazor-image-editor) component inside the razor file.

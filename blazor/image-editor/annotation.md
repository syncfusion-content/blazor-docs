...
@code {
    ...
    {
        ImageDimension Dimension = await ImageEditor.GetImageDimensionAsync();
        await ImageEditor.DrawTextAsync(Dimension.X.Value + 200, Dimension.Y.Value + 200, 'Syncfusion', 'Arial', 30, false, false, '', false, null, '', 'green', 8);
    }
    private async void DrawTextBackgroundColorAsync()
    {
        ImageDimension Dimension = await ImageEditor.GetImageDimensionAsync();
        await ImageEditor.DrawTextAsync(Dimension.X.Value + 300, Dimension.Y.Value + 300, 'Syncfusion', 'Arial', 30, false, false, '', false, null, 'red', '', null);
    }
}
```
...
@code {
    ...
    private async void RectangleAsync()
    {
        ...
        await ImageEditor.DrawRectangleAsync(250, 200, 120, 120, 4, "#fff", "blue", null, null, 8);
    }

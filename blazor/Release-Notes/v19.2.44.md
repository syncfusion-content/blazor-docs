...
|-------------------|----------------------|
|`services.AddSyncfusionBlazor(options => {`  <br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`options.IgnoreScriptIsolation = true;`<br>&nbsp;&nbsp;`}`| <br>`builder.Services.AddSyncfusionBlazor(options => {`  <br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`options.IgnoreScriptIsolation = true;`<br>&nbsp;&nbsp;`}` |
| //` _Host.cshtml`  <br>//` For Syncfusion Blazor overall Package`  <br>`<head>`<br>`...`<br>`<script src="_content/Syncfusion.Blazor/scripts/syncfusion-blazor.min.js" type="text/javascript"></script>`<br>`</head>`<br><br> //` For Individual Package`  <br>`<head>`<br>`...`<br>`<script src="Path for CRG generated script" type="text/javascript"></script>`<br>`</head>` | //` index.html`  <br>//` For Syncfusion Blazor overall Package`  <br>`<head>`<br>`...`<br>`<script src="_content/Syncfusion.Blazor/scripts/syncfusion-blazor.min.js" type="text/javascript"></script>`<br>`</head>`<br><br> //` For Individual Package`  <br>`<head>`<br>`...`<br>`<script src="Path for CRG generated script" type="text/javascript"></script>`<br>`</head>` |

...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Card](https://www.syncfusion.com/blazor-components/blazor-card) component inside the razor file.

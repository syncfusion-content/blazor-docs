...
# Getting Started with Blazor Card Component in Blazor Web App

This article provides a step-by-step instructions for building `Blazor Web App` with `Blazor Card` component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
Open **~/Components/_Imports.razor** file and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.Cards` namespace .
...
Add the Syncfusion Blazor Card component in the **~/Components/Pages/Home.razor** file. If you opt for an interactive location as Per page/component in the web app, define a render mode at the top of the ~Pages/*.razor component, as follows:

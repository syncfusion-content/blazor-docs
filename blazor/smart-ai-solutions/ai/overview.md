---
layout: post
title: Blazor AI Library Overview | Syncfusion®
...
- **Custom AI Service Extensibility**:
  ...
  - Maintains compatibility with Blazor components for seamless extension.
- **Foundation for Smart UI Components**:
  - Enables context-aware suggestions and automated content generation in Blazor components.
  - Powers intelligent user assistance across the [Blazor ecosystem](https://blazor.syncfusion.com/demos/).

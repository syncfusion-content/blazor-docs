...
description: Learn how to use Blazor Kanban with AI to automatically generate and assign tasks based on project descriptions.
platform: Blazor
control: AI Integration
documentation: ug
keywords: Blazor Kanban, AI task suggestion, Blazor AI
---

# Smart Task Suggestion in Blazor Kanban Component

This guide demonstrates how to use the [**Syncfusion.Blazor.AI**](https://www.nuget.org/packages/Syncfusion.Blazor.AI) package to enhance task planning in the Blazor Kanban component. The AI integration enables intelligent task generation based on project descriptions, sprint planning, and backlog management. These capabilities are powered by AI models hosted via services like OpenAI, Azure OpenAI, or Ollama.

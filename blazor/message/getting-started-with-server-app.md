---
layout: post
title: Getting Started with Blazor Message in Blazor Server App | Syncfusion
description: Check out and learn the documentation for getting started with Blazor Message Components in Server App.
platform: Blazor
control: Message
documentation: ug
---

# Getting Started with Blazor Message in Blazor Server App

...
description: Learn how to get started with the Syncfusion Blazor Message in a Blazor Server app with installation and setup steps.
platform: Blazor
control: Message
documentation: ug
---

# Getting Started with Message in Blazor Server App

This section briefly explains about how to include the [Blazor Message](https://www.syncfusion.com/blazor-components/blazor-message) component in a Blazor Server App using [Visual Studio](https://visualstudio.microsoft.com/vs/), [Visual Studio Code](https://code.visualstudio.com/), and the [.NET CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/).
...
After the packages are installed, open the **~/Components/_Imports.razor** file and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.Notifications` namespaces.
...
Include the required [script references](https://blazor.syncfusion.com/documentation/common/adding-script-references) at the end of the `<body>` section in the **App.razor** file to enable Message functionality.
...
Open a Razor file located in the **~/Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Message](https://www.syncfusion.com/blazor-components/blazor-message) component inside the razor file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [Blazor Message](https://www.syncfusion.com/blazor-components/blazor-message) component will render in your default web browser.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/LDhxtRqthosMbTzQ?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Message Component](./images/message-default.webp)" %}

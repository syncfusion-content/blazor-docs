...
description: Learn how to install, configure, and render the Syncfusion Blazor Message component in a Blazor Web App, including render modes, Client/Server setup, service registration, and theme/script references.
platform: Blazor
control: Message
documentation: ug
---

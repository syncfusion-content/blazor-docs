...
To add Blazor RadioButton component in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), search for [Syncfusion.Blazor.Buttons](https://www.nuget.org/packages/Syncfusion.Blazor.Buttons) and then install it.
...
* Now, add the Syncfusion RadioButton component in razor file. Here, the RadioButton component is added in the **~/Pages/Index.razor** file under the **~/Pages** folder.
...
> [View Sample in GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/RadioButton).
...
N> You can also explore our [Blazor Radio Button](https://blazor.syncfusion.com/demos/buttons/radio-button?) that shows you how to render and configure the Radio Button.

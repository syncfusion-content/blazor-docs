...
| --- | --- |
| `LabelPosition.Before` | Renders the label to the **left** of the RadioButton (right-to-left layouts render on the opposite side). |
| `LabelPosition.After` | Renders the label to the **right** of the RadioButton (right-to-left layouts render on the opposite side). |
...
* [Customization in Blazor RadioButton Component](./customization)

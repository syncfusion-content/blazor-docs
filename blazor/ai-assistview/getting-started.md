...
After the packages are installed, open the **~/_Imports.razor** file in the project root and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.InteractiveChat` namespaces.

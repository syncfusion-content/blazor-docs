...
description: Learn how to use a custom helper method inside a Blazor Data Grid column template loop to render dynamic content such as star ratings.
platform: Blazor
control: DataGrid
documentation: ug
---

# Use custom helper inside the loop with templates in Blazor Data Grid

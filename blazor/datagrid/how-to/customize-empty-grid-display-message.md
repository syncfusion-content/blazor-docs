...
The empty record template in the [Blazor DataGrid](https://www.syncfusion.com/blazor-components/blazor-datagrid) enables rendering custom content such as images, text, or other components when the Blazor Grid has no records to display. This replaces the default “No records to display” message.

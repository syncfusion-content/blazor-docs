...
The empty record template in the Syncfusion<sup style="font-size:70%">&reg;</sup> [Blazor DataGrid](https://www.syncfusion.com/blazor-components/blazor-datagrid) enables rendering custom content such as images, text, or other components when the Grid has no records to display. This replaces the default “No records to display” message.

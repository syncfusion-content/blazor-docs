...
By default, the [Blazor DataGrid](https://www.syncfusion.com/blazor-components/blazor-datagrid) occupies the full size of its parent element when the Blazor Grid [Height](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.SfGrid-1.html#Syncfusion_Blazor_Grids_SfGrid_1_Height) and [Width](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.SfGrid-1.html#Syncfusion_Blazor_Grids_SfGrid_1_Width) properties are set to 100%. When placing the same Blazor Grid inside the [SfTab](https://blazor.syncfusion.com/documentation/tabs/getting-started-webapp) component, however, it may consider the entire page height and render without a horizontal scrollbar.

To ensure the Blazor Grid scrolls within the Tab content area (keeping the tab header fixed), override the Tab content height with CSS so the Blazor Grid receives a well-defined parent height.

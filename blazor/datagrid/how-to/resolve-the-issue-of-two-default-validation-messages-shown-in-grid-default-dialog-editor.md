...
By default, the DataGrid uses two validator components. This issue occurs because the DataGrid uses both data annotation enabled and the ValidationMessage property defined, which can lead to the issue mentioned above. To resolve this issue, disable the built-in validator and achieve column validation solely using Data Annotations.

N> For more detailed information about this topic [here](https://blazor.syncfusion.com/documentation/datagrid/column-validation#disable-in-built-validator-component).

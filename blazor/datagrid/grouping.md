...
As demonstrated in the following sample, the Customer Name column is grouped and ungrouped dynamically through the Group Column and UnGroup Columns buttons utilizing these methods.

```cshtml
@using Syncfusion.Blazor.Grids
@using Syncfusion.Blazor.Buttons

<SfButton OnClick="GroupColumn" Content="Group"></SfButton>
<SfButton OnClick="UnGroupColumn" Content="UnGroup"></SfButton>

<SfGrid @ref="Grid" DataSource="@Orders" AllowGrouping="true" Height="400" TValue="Order">
    <GridColumns>

...
description:  Learn how to get started with Syncfusion DataGrid in a Blazor WebAssembly app, including project setup, package installation, configuration, and data binding.
platform: Blazor
control: DataGrid
documentation: ug
---

...
To get start quickly with Customize Autogenerated Columns using Data Annotations in Blazor DataGrid  Component,you can check on this video.

{% youtube
"youtube:https://www.youtube.com/watch?v=f7OIzUM0e7Y&t=2s" %}

...
> * When the header text is changed dynamically, the Blazor Grid does not update automatically. Call the `RefreshHeaderAsync` method to refresh the Blazor Grid and apply the updated header text.
...
> * The unique identifier is automatically generated by the Blazor Grid and changes whenever the Blazor Grid is refreshed or updated.

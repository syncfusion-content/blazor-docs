---
layout: post
title: Blazor Data Grid with MariaDB via Entity Framework | Syncfusion
...
![Basic DataGrid displaying subscriptions from the MariaDB Server database](../images/blazor-datagrid-mariadb-server.png)

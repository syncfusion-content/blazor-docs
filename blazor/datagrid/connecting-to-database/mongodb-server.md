...
The `Home.razor` component will display the project data in a Blazor DataGrid with search, filter, sort, and pagination capabilities.
...
![Basic Blazor DataGrid displaying projects from the MongoDB Server](../images/blazor-datagrid-mongodb.webp)

...
**6.** Finally, the retrieved data from SQLite Server database which is in the form of list of array can be found in an API controller available in the URL link `https://localhost:xxxx/api/Grid`, as shown in the browser page below.
...
> Find the sample from this [GitHub location](https://github.com/SyncfusionExamples/connecting-databases-to-blazor-datagrid-component/tree/master/Binding%20SQLite%20using%20UrlAdaptor).

## Binding data from SQLite Server using CustomAdaptor

This section describes step by step process how to retrieve data from a SQLite Server using `CustomAdaptor` and bind it to the Blazor DataGrid component.
...
Let’s see how to perform CRUD operation using SQLite Server data with Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor DataGrid component.
...
> You can find the sample in this [GitHub location](https://github.com/SyncfusionExamples/connecting-databases-to-blazor-datagrid-component/tree/master/Binding%20SQLite%20using%20CustomAdaptor).

...
The Grid component has support to display a value in a GridColumn which has foreign key behavior. It allows you to show multiple foreign key columns in Grid, i.e., datasources from different tables with foreign key behavior can be displayed in a Grid and perform Data/CRUD operations.

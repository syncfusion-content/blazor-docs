        ...
        Orders = Enumerable.Range(1, 75).Select(x => new Order()
            {
                ...
                ShipCity = (new string[] { "Lyon", "Charleroi", "Rio de Janeiro	", "Bern", "Genève" })[new Random().Next(5)],
                ShipName = (new string[] { "Victuailles en stock", "Suprêmes délices", "Hanari Carnes", "Chop-suey Chinese", "Richter Supermarkt" })[new Random().Next(5)],
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/BXLACZtAJzXOTHbn?appbar=false&editor=false&result=true&errorlist=false&theme=bootstrap5" %}
        ...
        Orders = Enumerable.Range(1, 10).Select(x => new Order()
            {
                ...
                CustomerID = (new string[] { "VINET", "TOMSP", "HANAR", "SUPRD", "CHOPS" })[new Random().Next(5)],
                ShipCity = (new string[] { "Lyon", "Charleroi", "Rio de Janeiro", "Bern", "Genève" })[new Random().Next(5)],
                ShipName = (new string[] { "Victuailles en stock", "Suprêmes délices", "Hanari Carnes", "Chop-suey Chines", "Ernst Handel" })[new Random().Next(5)],           
            }).ToList();
    }
    public class Order
    {

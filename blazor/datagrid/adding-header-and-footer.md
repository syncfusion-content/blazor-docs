...
The [Blazor Data Grid](https://www.syncfusion.com/blazor-components/blazor-datagrid) supports customizing header and footer sections in PDF exports. Header and footer regions can include:
...
The Blazor Data Grid supports adding custom text to header and footer regions in PDF exports.

`FromTop` sets the header offset from the top page edge. `FromBottom` sets the footer offset from the bottom page edge. Values use PDF points.

* The **header** appears at the top of each page and can include elements such as a document title, company logo, or date and metadata. Header content supports branding and document identification.

* The **footer** appears at the bottom of each page and commonly contains page numbers, copyright text, or disclaimers. Footer content supports navigation and compliance information.
            ...
            var exportProps = new PdfExportProperties
            {
                Header = new PdfHeader
                {
                    ...
                    Contents = new List<PdfHeaderFooterContent>
                    {
                        new PdfHeaderFooterContent
                        {
                            ...
                            Value = "PDF Header Text", // Set the text to display in PDF document header section.
                ...
                Footer = new PdfFooter
                {
                    ...
                    Contents = new List<PdfHeaderFooterContent>
                    {
                        ...
                        {
                            Type = ContentType.Text, // Set content type as text.    
                            Value = "PDF Footer Text", // Set the text to display in PDF document footer section.    
...
The Blazor Data Grid supports drawing lines in header and footer regions when exporting to PDF. **Lines** are commonly used to visually separate header and footer regions from the main content.
...
4. Define line coordinates using [PdfPoints](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.PdfPoints.html) through `Points`. The `X1` and `Y1` properties define the starting point. The `X2` and `Y2` properties define the ending point.

> Line coordinates are relative to the PDF page. Values may require adjustment for different page sizes, portrait or landscape mode, and custom margins.
...
The Blazor Data Grid supports adding page numbers to header and footer regions when exporting to PDF. Page numbers improve document navigation and readability.
...
The display format is controlled by [PageNumberType](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.PdfPageNumberType.html#fields), with these formats:

* Arabic and Number – 1, 2, 3. Arabic and Number use Arabic numerals in the current export API.
* LowerLatin – a, b, c
* UpperLatin – A, B, C
* LowerRoman – i, ii, iii
* UpperRoman – I, II, III
...
@code {
    ...
    public async Task ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
    {
        if (args.Item.Id == "Grid_pdfexport")
        {
            // Parse the selected dropdown value as PdfPageNumberType.
            ...
            var pageNumber = new PdfHeaderFooterContent
            {
                ...
                Position = new PdfPosition { X= 360, Y = 20 }, // Set the header or footer text position.
                Style = new PdfContentStyle
                {
...
The Blazor Data Grid supports adding images, such as company logos, to header and footer regions when exporting to PDF. Image content supports branding and document personalization.
       ...
       new PdfHeaderFooterContent()
        {
            ...
            Src = "...", // Replace ... with the complete Base64-encoded JPEG string before export.
...
The Blazor Data Grid supports repeating column headers on every page of a PDF export. Repeated headers remain visible when content spans multiple pages. By default, headers appear only on the first page.

Set the [IsRepeatHeader](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.PdfExportProperties.html#Syncfusion_Blazor_Grids_PdfExportProperties_IsRepeatHeader) property in [PdfExportProperties](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.PdfExportProperties.html) to **true**. The [PdfHeaderQueryCellInfo](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.GridEvents-1.html#Syncfusion_Blazor_Grids_GridEvents_1_PdfHeaderQueryCellInfoEvent) event provides optional header appearance customization.

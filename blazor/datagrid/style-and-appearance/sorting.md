...
Adjust properties such as **content**, **color**, **font-size**, and **margin** to match the DataGrid design. Ensure the correct icon font family is loaded to display the icons properly.
...
Modify properties such as **background-color**, **font-family**, **font-size**, and **border-radius** to align with the DataGrid layout. Ensure accessibility by maintaining clear contrast and focus styles.

...
@code {
    ...
    public List<ColumnMenuItemModel> menuItem = new List<ColumnMenuItemModel> { new ContextMenuItemModel { Text = "GroupBythisColumn", Id = "GroupBythisColumn" }, new ContextMenuItemModel { Text = "UnGroupBythisColumn", Id = "UnGroupBythisColumn" }, new ContextMenuItemModel { Text = "SortAscending", Id = "SortAscending" },new ContextMenuItemModel{Text="SortDescending",Id ="SortDescending"}, new ContextMenuItemModel { Text = "Aggregates", Id = "Aggregates", Items = (new List<MenuItem> { new MenuItem { Text = "Sumof", Id = "Sumof" },new MenuItem{Text="Averageof",Id="Averageof" } })
} };
    ...
    public void ColumnMenuItemClickedHandler(ColumnMenuClickEventArgs args)
    {
        if (args.Item.Text == "GroupBythisColumn")
        {
            var column = args.Column.Field;
            DefaultGrid.GroupColumnAsync(column);

        }
        else if (args.Item.Text == "UnGroupBythisColumn")
        {
            var column = args.Column.Field;
            DefaultGrid.UngroupColumnAsync(column);
        }
        else if (args.Item.Text == "SortAscending")
        {
            var column = args.Column.Field;
            DefaultGrid.SortColumnAsync(column, SortDirection.Ascending);

        }
        else if (args.Item.Text == "SortDescending")
        {
            var column = args.Column.Field;
            DefaultGrid.SortColumnAsync(column, SortDirection.Descending);
        }
        else if (args.Item.Text == "Sumof")
        {
            // Here, you can customize your code.
        }
        else if (args.Item.Text == "Averageof")
        {
            // Here, you can customize your code.
        }
    }
...
Custom column menu items can be added by defining the [`ColumnMenuItems`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartSeries.html#Syncfusion_Blazor_Charts_ChartSeries_Type) as a collection of the [`ColumnMenuItemModel`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.ColumnMenuItemModel.html).

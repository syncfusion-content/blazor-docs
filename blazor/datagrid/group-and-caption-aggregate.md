...
Here’s an example that demonstrates how to use group footer aggregates in the Syncfusion&reg; Blazor Grid component:
...
Here’s an example that demonstrates how to use group and caption aggregates in the Syncfusion&reg; Blazor Grid component:
...
> The group total summary in Syncfusion&reg; Grid is calculated based on the current page records for each group by default.
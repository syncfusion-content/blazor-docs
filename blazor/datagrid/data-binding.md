...
<SfGrid ID="Grid" DataSource="CustomerList" Toolbar="@ToolbarItems" AllowExcelExport="true" @ref="DefaultGrid" >
...
@code{
    ...
    private List<string> ToolbarItems = new List<string>(){ "ExcelExport"};
    string[] Columns;

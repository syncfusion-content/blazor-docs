...
## Creating custom components or hierarchical Data Grids
...
To render a custom component or build a hierarchical grid inside the detail row, define the template in the [DetailTemplate](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Grids.GridTemplates.html#Syncfusion_Blazor_Grids_GridTemplates_DetailTemplate) within the `GridTemplates` section. The hierarchical Data Grid displays data in expandable or collapsible levels using the expand or collapse button, or custom content such as HTML elements.
...
## Template column in detail Data Grid
...
## Hide the expand/collapse icon in parent row when no record in detail Data Grid

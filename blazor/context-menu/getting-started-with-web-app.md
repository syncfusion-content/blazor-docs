---
layout: post
title: Getting Started with Web App for Blazor ContextMenu Component in Visual Studio
description: Check out the documentation for getting started with Blazor ContextMenu Component in Blazor Web App.
platform: Blazor
...
This article provides a step-by-step instructions for building `Blazor Web App` with `Blazor ContextMenu` component using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
Add the Syncfusion Blazor ContextMenu component in the **~/Components/Pages/Home.razor** file. If you opt for an interactive location as Per page/component in the web app, define a render mode at the top of the ~Pages/*.razor component, as follows:

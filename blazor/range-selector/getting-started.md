...
description: Checkout and learn about getting started with Blazor Range Selector component in Blazor WebAssembly Application with examples and much more details.
platform: Blazor
...
Add the Blazor Range Selector component in the **~/Pages/Index.razor** file.

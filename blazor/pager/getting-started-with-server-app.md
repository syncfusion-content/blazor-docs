...
description: Learn how to configure and use Blazor Pager component in a Blazor Server App for efficient navigation and paging.
platform: Blazor
control: Pager
documentation: ug
---
...
Add the Blazor Pager component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `~Pages/Home.razor` file.

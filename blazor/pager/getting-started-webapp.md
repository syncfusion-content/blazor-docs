---
layout: post
title: Getting Started with Blazor Pager Component in Blazor Web App | Syncfusion®
description: Learn how to configure and use Blazor Pager component in a Blazor Web App for efficient navigation and paging.
platform: Blazor
control: Pager
documentation: ug
---
...
Add the Blazor Pager component in the **~/Components/Pages/*.razor** file. If the interactivity location is set to `Per page/component` in the Web App, define a render mode at the top of the `~/Pages/*.razor` file. (For example, `InteractiveServer`, `InteractiveWebAssembly` or `InteractiveAuto`).

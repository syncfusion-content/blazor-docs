...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor Button](https://www.syncfusion.com/blazor-components/blazor-button) component inside the razor file.

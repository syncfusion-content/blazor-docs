...
After successful compilation of your application, simply press F5 to run the application. The Blazor Button component will be rendered in the web browser as shown below

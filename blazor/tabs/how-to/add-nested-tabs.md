---
layout: post
title: How to add nested tabs in Blazor Tabs | Syncfusion
description: Render nested Blazor Tabs inside a parent tab ContentTemplate for hierarchical navigation and structured content.
platform: Blazor
control: Tabs
documentation: ug
---

# How to add nested tabs in Blazor Tabs

The Blazor Tabs component supports rendering nested levels of Blazor Tabs by using the `ContentTemplate` property. To render Blazor nested Tabs, define the Blazor nested Tabs elements within the `ContentTemplate` of the parent Blazor tabs.
...
![Adding Blazor Nested Tabs](../images/blazor-nested-tabs.webp)
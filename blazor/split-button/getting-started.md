...
description: Checkout and learn about getting started with Blazor SplitButton component of Syncfusion, and more details.
platform: Blazor
...
This section briefly explains about how to include Split Button Component in your Blazor server-side  application. You can refer [Getting Started with Syncfusion Blazor for Server-side in Visual Studio](https://blazor.syncfusion.com/documentation/getting-started/blazor-server-side-visual-studio/) page for the introduction and configuring the common specifications.

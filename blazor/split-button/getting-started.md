---
layout: post
title: Getting Started with Blazor Split Button in Blazor WASM App | Syncfusion
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor Split Button component will render in your default web browser.

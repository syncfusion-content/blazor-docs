...
To get start quickly with Split Button Component using Blazor, you can check on this video or [GitHub](https://github.com/SyncfusionExamples/Blazor-Getting-Started-Examples/tree/main/SplitButton) sample:
...
Add the Syncfusion&reg; Blazor Split Button component in the **~/Pages/Index.razor** file.

...
Add the Blazor Split Button component in the **~/Pages/Index.razor** file.
...
* Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. This renders the Blazor Split Button component in the default web browser.

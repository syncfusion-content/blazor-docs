...
description: Checkout and Learn here all about the Accessibility in Syncfusion Blazor Diagram component and more.
platform: Blazor
...
Diagram provides built-in compliance with the [WAI-ARIA](https://www.w3.org/TR/wai-aria-practices/) specifications. WAI-ARIA Accessibility supports are achieved through the attributes like `aria-label`. It helps to provides information about elements in a document for assistive technology.

...
Diagram allows to create the [polygon](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Diagram.BasicShape.html) shape by clicking and moving the mouse at runtime on the diagram page.

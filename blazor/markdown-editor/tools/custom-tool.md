---
layout: post
title: Custom tool in Blazor Markdown Editor | Syncfusion
description: Checkout and learn here all about Custom tool in Syncfusion Blazor Markdown Editor and more.
platform: Blazor
...
This sample shows how to add your tools to the toolbar of Markdown Editor inside the Rich Text Editor. The `Ω` command is added to insert special characters in the editor.
...
![Blazor Markdown Editor customize toolbar](../images/blazor-markdown-editor-custom-tool.png)
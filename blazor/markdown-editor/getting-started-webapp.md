...
Open a Razor file located in the **~/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Markdown Editor](https://www.syncfusion.com/blazor-components/blazor-rich-text-editor) component inside the `.Client` project razor file.
...
1. [Getting Started with Blazor for Web app in .NET Core CLI](../getting-started/blazor-web-app-dotnet-cli)

2. [Getting Started with Blazor for server-side in Visual Studio](../getting-started/blazor-server-side-visual-studio)

3. [Getting Started with Blazor for Web app](../getting-started/blazor-web-app)

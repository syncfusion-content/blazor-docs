---
layout: post
title: Getting Started with Blazor Smart TextArea Component | Syncfusion
description: Checkout and learn about getting started with Blazor Smart TextArea component in Blazor Server App.
platform: Blazor

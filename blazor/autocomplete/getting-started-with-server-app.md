---
layout: post
title: Getting Started with AutoComplete in Blazor Server App | Syncfusion®
...
Register the Blazor Service in the **~/Program.cs** file of the Blazor Server App.
...
Add the Blazor AutoComplete component in the **~/Components/Pages/Home.razor** file. If the interactivity location is set to `Per page/component`, define a render mode at the top of the `Home.razor` page.

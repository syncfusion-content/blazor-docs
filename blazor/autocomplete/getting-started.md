...
Open a Razor file located in the **~/Pages/*Index.razor** and add the [Blazor AutoComplete](https://www.syncfusion.com/blazor-components/blazor-autocomplete) component inside the razor file.

---
layout: post
title: Animation in Blazor Linear Gauge | Syncfusion®
description: Animate axis, ticks, labels, ranges, pointers, and annotations sequentially in the Blazor Linear Gauge by setting the AnimationDuration property.
platform: Blazor
control: Linear Gauge
documentation: ug
---

# Animation in Blazor Linear Gauge

---
layout: post
title: Ranges in Blazor Linear Gauge | Syncfusion®
description: Add ranges to the Blazor Linear Gauge with start, end, color, position, gradient, and multiple-range configurations for value thresholds.
platform: Blazor

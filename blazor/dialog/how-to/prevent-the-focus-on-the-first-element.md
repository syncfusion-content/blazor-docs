...
By default, the Blazor dialog focuses on the first focusable element of the content area when it opens. You can prevent this default focusing behavior using the `Opened` event and by setting the `PreventFocus` argument on the `OpenEventArgs`.

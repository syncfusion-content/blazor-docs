...
You can prevent opening of the dialog by setting the `OnOpen` event argument cancel value to true. In the following sample, the success dialog is opened when you enter the username and password values with minimum 4 characters. Otherwise, it will not be opened.

...
description: Check out and learn about how to get started with the Blazor Dialog Component in the Blazor Server App.
platform: Blazor
component: Dialog
documentation: ug
---

# Getting Started with Blazor Dialog Component in Blazor Server App

...
Keys | Description |
|-----|-----|
| <kbd>Tab</kbd> |  Focuses the toggle icons, cells, or cards.. |
| <kbd>Left Arrow </kbd> | Moves focus to the previous cell within the row. |
| <kbd>Right Arrow</kbd> | Moves focus to the next cell within the row. |
| <kbd>Down Arrow</kbd>  | Moves focus to the next card. |
| <kbd>Up Arrow</kbd>  | Moves focus to the previous card. |
| Focus Card + <kbd>Enter/Space </kbd> | Selects the focused card. |
| Focus Icon + <kbd>Enter/Space </kbd> | Performs Expand/Collapse functions. If the cell is focused, then the cards get focused. |
| Selected Card + <kbd>Enter/Space</kbd>  | Opens the Dialog Editing. |
| <kbd>Home </kbd> | Selects the first card. |
| <kbd>End</kbd> | Selects the last card. |
| <kbd>Ctrl</kbd> + <kbd>Enter/Space</kbd> | Selects multiple cards. |
| <kbd>Shift</kbd> + <kbd>Tab</kbd> | Focuses icons, cells, or cards in the reverse direction  |
| <kbd>Shift</kbd> + <kbd>Up Arrow</kbd> | Selects multiple items above the currently selected item.  |
| <kbd>Shift</kbd> + <kbd>Down Arrow</kbd> | Selects multiple items below the currently selected item. |
| <kbd>Escape</kbd> | Removes the card selection if the card is selected (or) Removes the card focus and focuses on cells (or) Closes the Dialog when the Dialog is opened. |
...
<SfKanban TValue="TasksModel" KeyField="Status" DataSource="Tasks" AllowKeyboard="false">
    <KanbanColumns>
